...
const CATEGORY_CONFIG: Record<string, { icon: typeof Wallet; gradient: string; bg: string; label: string }> = {
  TOP_UP: { icon: Plus, gradient: 'from-[#7DB0FF] to-[#4D8AFF]', bg: 'bg-[#FFCE32]/10', label: 'Top Up' },
  BOOKING: { icon: CreditCard, gradient: 'from-[#4D8AFF] to-[#1D63FF]', bg: 'bg-[#1D63FF]/10', label: 'Booking' },
  EARNING: { icon: TrendingUp, gradient: 'from-[#7DB0FF] to-[#4D8AFF]', bg: 'bg-[#FFCE32]/10', label: 'Earning' },
  CASHBACK: { icon: Gift, gradient: 'from-[#FFCE32] to-[#1D63FF]', bg: 'bg-[#1D63FF]/10', label: 'Cashback' },
  ...
  PROMO: { icon: Gift, gradient: 'from-[#4D8AFF] to-[#FFCE32]', bg: 'bg-[#FFCE32]/10', label: 'Promo' },
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <motion.div {...fadeUp} transition={{ duration: 0.4 }}>
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#0D3B7A] via-[#1D63FF] to-[#FFCE32] p-6 sm:p-8 shadow-xl shadow-[#1D63FF]/20">
          ...
          <div className="relative">
            ...
            {walletLoading ? (
              ...
              <div className="mt-2 flex items-baseline gap-1">
                <IndianRupee className="size-7 text-[#FFCE32] sm:size-8" />
            ...
            <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-3">
              <div className="rounded-xl bg-white/10 p-3 backdrop-blur-sm">
                <div className="flex items-center gap-1.5 text-[#FFCE32]">
      ...
      >
        <motion.div variants={fadeUp}>
          <button
            ...
            className="group flex w-full flex-col items-center gap-3 rounded-2xl bg-gradient-to-br from-[#4D8AFF] to-[#1D63FF] p-5 text-white shadow-lg shadow-[#1D63FF]/25 transition-shadow hover:shadow-xl"
          >
            ...
            {txLoading ? (
              ...
              <div className="py-12 text-center">
                <div className="mx-auto flex size-16 items-center justify-center rounded-2xl bg-[#FFCE32]/10">
                  <History className="size-8 text-[#7DB0FF]" />
                </div>
                ...
                {filteredTransactions.length > 8 && (
                  <div className="mt-3 flex justify-center">
                    <Button
                      ...
                      className="text-[#1D63FF] hover:text-[#0D3B7A] hover:bg-[#FFCE32]/10"
                    >
                      {showAllTx ? (
            ...
            <>
              ...
              <div className="flex flex-col items-center py-8 text-center">
                <motion.div
                  ...
                  className="flex size-20 items-center justify-center rounded-full bg-[#FFCE32]/10"
                >
                ...
                <Button
                  className="mt-6 bg-gradient-to-r from-[#4D8AFF] to-[#1D63FF] text-white shadow-lg shadow-[#1D63FF]/25"
            ...
            <>
              ...
              <div className="space-y-5 pt-2">
                  ...
                  <div className="flex gap-2">
                    {[100, 500, 1000, 2000].map((amt) => (
                      <button
                        ...
                        className="rounded-lg border border-[#FFCE32]/30 bg-[#FFCE32]/10/50 px-3 py-1.5 text-xs font-medium text-[#0D3B7A] transition-all hover:bg-[#FFCE32]/10"
                      >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`flex flex-col items-center gap-2 rounded-xl border-2 p-4 transition-all ${
                        withdrawMethod === 'BANK'
                          ? 'border-[#4D8AFF] bg-[#FFCE32]/10 shadow-sm'
                          : 'border-muted hover:border-[#FFCE32]/30 hover:bg-[#FFCE32]/10/30'
                      }`}
                    >
                ...
                {withdrawAmount && parseFloat(withdrawAmount) > 0 && (
                  <div className="rounded-xl border border-[#FFCE32]/30 bg-[#FFCE32]/10/30 p-4">
              ...
              <DialogFooter className="gap-2 sm:gap-0">
                ...
                <Button
                  ...
                  className="rounded-xl bg-gradient-to-r from-[#4D8AFF] to-[#1D63FF] text-white shadow-lg shadow-[#1D63FF]/25"
                >
                  {mutating ? (
                    <>
