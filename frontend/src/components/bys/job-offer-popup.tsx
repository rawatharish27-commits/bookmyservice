  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => { if (!isOpen) handleClose(); }}>
      <DialogContent
        ...
        className="sm:max-w-2xl p-0 overflow-hidden border-0 bg-gradient-to-br from-[#0A1F44] via-[#132D5E] to-[#FFD54F] text-white"
      >
        {/* Header section */}
        <div className="relative px-6 pt-6 pb-4">
          ...
          <DialogHeader className="relative z-10">
            ...
            <DialogDescription className="text-sm sm:text-base text-[#F2C94C]/80 mt-1">
        ...
        <div className="px-6 pb-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              <Card className="bg-white/10 backdrop-blur-sm border border-white/20 hover:border-white/40 transition-all duration-300 hover:shadow-lg hover:shadow-yellow-500/10 group cursor-pointer">
                <CardContent className="p-5">
                  ...
                  <p className="text-xs text-[#F2C94C]/70 mb-4">
                    Manage multiple cities and oversee operations across your region.
                  </p>

                  <div className="space-y-2 mb-5">
                    <div className="flex items-center gap-2 text-sm text-[#F2C94C]/90">
            ...
            >
              <Card className="bg-white/10 backdrop-blur-sm border border-white/20 hover:border-white/40 transition-all duration-300 hover:shadow-lg hover:shadow-[#FFD54F]/10 group cursor-pointer">
                <CardContent className="p-5">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-[#FFD54F]/20 to-[#E0B84C]/20 border border-[#FFD54F]/30">
                      <Users className="w-6 h-6 text-[#FFD54F]" />
                    </div>
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#FFD54F]/20 border border-[#FFD54F]/30 text-[#FFD54F] text-xs font-semibold">
                  ...
                  <div className="space-y-2 mb-5">
                    <div className="flex items-center gap-2 text-sm text-[#F2C94C]/90">
                      <MapPin className="w-3.5 h-3.5 text-[#FFD54F]/70 flex-shrink-0" />
                      <span>Manage your city operations</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-[#F2C94C]/90">
                      <Users className="w-3.5 h-3.5 text-[#FFD54F]/70 flex-shrink-0" />
                      <span>Coordinate local providers</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-[#F2C94C]/90">
                      <DollarSign className="w-3.5 h-3.5 text-[#FFD54F]/70 flex-shrink-0" />
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <span className="text-xs text-white/60">Registration Fee</span>
                      <p className="text-lg font-bold text-[#FFD54F]">₹50</p>
                    </div>
                    <Button
                      onClick={handleApplyLocalAdmin}
                      className="bg-gradient-to-r from-[#FFD54F] to-[#E0B84C] hover:from-[#E0B84C] hover:to-[#FFD54F] text-[#0A1F44] font-semibold gap-1.5 shadow-lg shadow-[#FFD54F]/25 transition-all duration-200 group-hover:shadow-[#FFD54F]/40"
                      size="sm"
                    >
                      Apply Now
                      <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-0.5" />
          ...
          >
            <Button
              variant="ghost"
              onClick={handleClose}
              className="text-[#F2C94C]/60 hover:text-white hover:bg-white/10 transition-colors"
            >
              Maybe Later
            </Button>
          </motion.div>
