...
const CATEGORY_GRADIENTS: Record<string, {
  ...
  plumbing: {
    ...
    headerGradient: 'from-[#0A1F44] via-[#132D5E] to-[#FFD54F]',
    lightBg: 'bg-[#E0B84C]/5',
    lightText: 'text-[#0A1F44]',
    glow: 'shadow-[#E0B84C]/25',
    borderAccent: 'border-[#E0B84C]/30',
    badgeBg: 'bg-[#E0B84C]/10/80',
    badgeText: 'text-[#0A1F44]',
    hoverBg: 'hover:bg-[#E0B84C]/5',
    ringColor: 'ring-[#FFD54F]/30',
    shadowGlow: 'shadow-[#E0B84C]/15',
    heroGradient: 'from-[#0A1F44] via-[#E0B84C] to-[#FFD54F]',
  },
  electrical: {
    gradient: 'from-[#E0B84C] to-[#FFD54F]',
    headerGradient: 'from-[#0A1F44] via-[#132D5E] to-[#FFD54F]',
  ...
  'air-conditioner': {
    ...
    headerGradient: 'from-[#0A1F44] via-[#132D5E] to-[#FFD54F]',
    lightBg: 'bg-[#FFD54F]/5',
    lightText: 'text-[#132D5E]',
    glow: 'shadow-[#E0B84C]/25',
    borderAccent: 'border-[#FFD54F]/30',
    badgeBg: 'bg-[#FFD54F]/5/80',
    badgeText: 'text-[#132D5E]',
...
const DEFAULT_GRADIENT = {
  ...
  lightBg: 'bg-[#FFD54F]/5',
  lightText: 'text-[#132D5E]',
  glow: 'shadow-[#FFD54F]/25',
  borderAccent: 'border-[#FFD54F]/30',
  badgeBg: 'bg-[#FFD54F]/5/80',
  badgeText: 'text-[#132D5E]',
  hoverBg: 'hover:bg-[#FFD54F]/5',
  ringColor: 'ring-[#FFD54F]/30',
  shadowGlow: 'shadow-[#FFD54F]/15',
  heroGradient: 'from-[#0A1F44] via-[#E0B84C] to-[#FFD54F]',
};
...
export function CategoriesPage() {
  ...
  return (
    <div className="flex flex-col">
      {/* ═══════════ Hero Header ═══════════ */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0A1F44] via-[#132D5E] to-[#132D5E]">
        {/* Mesh gradient background with animated orbs */}
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          {/* Primary large orbs */}
          <motion.div
            className="absolute -left-32 -top-32 size-[700px] rounded-full bg-gradient-to-br from-[#FFD54F]/25 to-[#FFD54F]/10 blur-3xl"
            animate={{ x: [0, 40, 0], y: [0, -30, 0] }}
            transition={{ duration: 14, repeat: Infinity, ease: 'easeInOut' }}
          />
          <motion.div
            className="absolute -bottom-24 -right-24 size-[600px] rounded-full bg-gradient-to-tl from-[#FFD54F]/25 to-[#FFD54F]/10 blur-3xl"
            animate={{ x: [0, -35, 0], y: [0, 25, 0] }}
            transition={{ duration: 12, repeat: Infinity, ease: 'easeInOut' }}
          />
          <motion.div
            className="absolute left-1/3 top-1/4 size-[400px] rounded-full bg-gradient-to-br from-[#FFD54F]/15 to-[#F2C94C]/8 blur-3xl"
            animate={{ scale: [1, 1.25, 1], x: [0, 20, 0] }}
            transition={{ duration: 10, repeat: Infinity, ease: 'easeInOut' }}
          />
          {/* Secondary smaller orbs */}
          <motion.div
            className="absolute right-1/4 top-1/3 size-[250px] rounded-full bg-gradient-to-bl from-[#FFD54F]/20 to-transparent blur-3xl"
            animate={{ y: [0, -40, 0], scale: [1, 1.15, 1] }}
            transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
          />
          <motion.div
            className="absolute bottom-1/4 left-1/4 size-[200px] rounded-full bg-gradient-to-tr from-[#F2C94C]/15 to-transparent blur-3xl"
            animate={{ y: [0, 30, 0] }}
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
          ...
          >
            <Breadcrumb>
              <BreadcrumbList className="text-white/80/70">
                ...
                <BreadcrumbSeparator className="text-[#FFD54F]/30" />
                <BreadcrumbItem>
          ...
          <div className="text-center">
            ...
            >
              <Badge className="mb-6 border-[#FFD54F]/20 bg-[#FFD54F]/15 px-5 py-2 text-sm font-medium text-[#0A1F44]/70 backdrop-blur-sm hover:bg-[#FFD54F]/25">
            ...
            {!loading && categories.length > 0 && (
              ...
              >
                <div className="inline-flex items-center gap-0 rounded-2xl border border-[#FFD54F]/15 bg-[#0A1F44]/40 backdrop-blur-xl">
                  ...
                  <div className="size-px h-12 bg-gradient-to-b from-transparent via-[#FFD54F]/25 to-transparent" />
                  <div className="px-8 py-4 text-center sm:px-10">
                    <p className="text-3xl font-bold text-white sm:text-4xl">
      ...
      <section className="relative z-10 bg-white">
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          >
            {[
              { icon: <ShieldCheck className="size-5" />, label: 'Verified Providers', gradient: 'from-[#0A1F44] to-[#FFD54F]' },
              { icon: <Clock className="size-5" />, label: 'On-Time Service', gradient: 'from-[#0A1F44] to-[#132D5E]' },
              { icon: <Users className="size-5" />, label: 'Trusted by Thousands', gradient: 'from-[#E0B84C] to-[#FFD54F]' },
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <Badge className="mb-4 border-[#FFD54F]/30 bg-[#FFD54F]/5 text-[#132D5E] hover:bg-[#FFD54F]/5">
          ...
          {error && (
            ...
            >
              ...
              <Button
                ...
                size="lg"
                onClick={refetch}
                className="mt-6 border-[#FFD54F]/30 text-[#132D5E] hover:bg-[#FFD54F]/5"
              >
                Retry
              </Button>
            </motion.div>
                          ...
                          >
                            ...
                            <CardContent className="relative p-7">
                              ...
                              <div className="mt-6 flex items-center justify-between border-t border-gray-100 pt-5">
                                <div className="flex items-center gap-2 text-sm font-semibold text-[#0A1F44] transition-all duration-300 group-hover:gap-3 group-hover:text-[#FFD54F]">
                                  Explore Services
          ...
          {!loading && !error && categories.length === 0 && (
            ...
            >
              ...
              <div className="relative mx-auto mb-6 size-36">
                <div className="absolute inset-0 rounded-full bg-[#FFD54F]/5" />
                <div className="absolute inset-4 rounded-full bg-[#FFD54F]/5/50" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <Search className="size-14 text-[#0A1F44]" />
                </div>
                {/* Decorative dots */}
                <div className="absolute -right-2 top-2 size-3 rounded-full bg-[#FFD54F]" />
                <div className="absolute -left-1 bottom-4 size-2 rounded-full bg-[#FFD54F]" />
                <div className="absolute right-4 -bottom-1 size-2.5 rounded-full bg-[#FFD54F]/20" />
              </div>
              ...
              <Button
                className="mt-6 bg-[#FFD54F] text-[#0A1F44] hover:bg-[#132D5E] hover:text-white"
                onClick={() => navigate('home')}
              >
                Back to Home
              </Button>
      ...
      {!loading && !error && categories.length > 0 && (
        <section className="relative overflow-hidden bg-gradient-to-b from-gray-50/80 to-white py-20">
          ...
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute -left-40 top-0 size-[500px] rounded-full bg-[#FFD54F]/5/60 blur-3xl" />
            <div className="absolute -bottom-40 -right-40 size-[500px] rounded-full bg-[#FFD54F]/5/60 blur-3xl" />
          </div>
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <Badge className="mb-5 border-[#FFD54F]/30 bg-[#FFD54F]/5 text-[#132D5E] hover:bg-[#FFD54F]/5">
              ...
              {[
                {
                  ...
                  gradient: 'from-[#0A1F44] to-[#FFD54F]',
                  bg: 'bg-[#FFD54F]/5',
                  shadow: 'shadow-[#FFD54F]/20',
                },
                {
                  ...
                  gradient: 'from-[#FFD54F] to-[#0A1F44]',
                  bg: 'bg-[#E0B84C]/5',
                  shadow: 'shadow-[#E0B84C]/20',
                },
                {
                  ...
                  gradient: 'from-[#0A1F44] to-[#E0B84C]',
                  bg: 'bg-[#E0B84C]/5',
                  shadow: 'shadow-[#E0B84C]/20',
                },
              ].map((item, idx) => (
      ...
      {!loading && !error && categories.length > 0 && (
        <section className="relative overflow-hidden bg-gradient-to-br from-[#FFD54F]/5 via-white to-[#FFD54F]/5 py-20">
          {/* Background decorations */}
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute -left-32 top-0 size-[500px] rounded-full bg-[#FFD54F]/5/50 blur-3xl" />
            <div className="absolute -bottom-32 -right-32 size-[500px] rounded-full bg-[#FFD54F]/5/50 blur-3xl" />
            <div className="absolute left-1/2 top-1/2 size-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#E0B84C]/5/30 blur-3xl" />
          </div>
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-[#0A1F44] via-[#E0B84C] to-[#FFD54F] p-[2px]">
              ...
              <div className="relative glass-emerald rounded-3xl px-8 py-14 text-center sm:px-16 sm:py-20">
                ...
                <div className="pointer-events-none absolute -left-16 -top-16 size-52 rounded-full bg-[#FFD54F]/10/30 blur-3xl" />
                <div className="pointer-events-none absolute -bottom-16 -right-16 size-52 rounded-full bg-[#FFD54F]/10/30 blur-3xl" />
                <div className="pointer-events-none absolute left-1/2 top-1/2 size-40 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#FFD54F]/10/20 blur-3xl" />
                ...
                <div className="relative">
                  <motion.div
                    ...
                    className="mx-auto mb-8 flex size-20 items-center justify-center rounded-2xl bg-gradient-to-br from-[#0A1F44] to-[#132D5E] text-[#FFD54F] shadow-xl shadow-[#FFD54F]/30"
                  >
                  ...
                  <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                    <Button
                      className="shimmer bg-gradient-to-r from-[#FFD54F] to-[#E0B84C] px-10 py-6 text-lg font-semibold text-[#0A1F44] shadow-xl shadow-[#FFD54F]/25 hover:from-[#E0B84C] hover:to-[#FFD54F]"
                      size="lg"
                    ...
                    <Button
                      variant="outline"
                      size="lg"
                      className="border-[#FFD54F]/30 px-8 py-6 text-lg font-semibold text-[#132D5E] hover:bg-[#FFD54F]/5"
                      onClick={() => navigate('home')}
                    >
                      Back to Home
                    </Button>
