...
const TABS = [
  { key: 'PENDING', label: 'New Requests', gradient: 'from-cyan-400 to-blue-500', icon: Clock },
  { key: 'ACCEPTED', label: 'Accepted', gradient: 'from-sky-400 to-blue-500', icon: CheckCircle2 },
  { key: 'IN_PROGRESS', label: 'In Progress', gradient: 'from-sky-400 to-sky-500', icon: Play },
    ...
    switch (booking.status) {
      ...
      case 'ACCEPTED':
        return (
          <Button
            size="sm"
            className="bg-gradient-to-r from-blue-500 to-sky-600 text-white shadow-sm rounded-lg"
