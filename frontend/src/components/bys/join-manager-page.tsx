      ...
      <motion.div {...fadeUp} transition={{ duration: 0.4 }}>
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage className="font-semibold text-[#FFD54F]">Join as Area Manager</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </motion.div>
      ...
      >
        ...
        <div className="relative text-center">
          ...
          <h1 className="mb-3 text-4xl font-bold text-white sm:text-5xl">
            Join as <span className="text-[#FFD54F]">Area Manager</span>
          </h1>
              ...
              <AnimatePresence mode="wait">
                {step === 'success' ? (
                    ...
                    <div className="mb-6 rounded-xl border border-gray-200 bg-gray-50/50 p-5">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-[#0A1F44]">Area Manager</span>
                        </div>
                        <div className="flex justify-between">
                  ...
                  >
                    ...
                    <h2 className="text-xl font-bold text-[#0A1F44]">Area Manager Application</h2>
                    ...
                    <div className="rounded-xl border border-gray-200 bg-gray-50/50 p-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-1">
                          <Label htmlFor="terms-agree" className="cursor-pointer text-sm font-medium leading-snug text-[#0A1F44]">
        ...
        >
          ...
          <div className="overflow-hidden rounded-2xl border-0 shadow-lg">
            ...
            <div className="bg-white p-6">
              <h3 className="mb-5 text-lg font-bold text-[#0A1F44]">Why Become an Area Manager?</h3>
              <div className="space-y-4">
                {[
                  { icon: <Shield className="size-5" />, title: 'Lead Your City', desc: 'Manage all service operations in your designated area', gradient: 'from-[#0A1F44] to-[#132D5E]' },
                  { icon: <Briefcase className="size-5" />, title: 'Earn Commissions', desc: '3% commission on every booking in your area', gradient: 'from-[#132D5E] to-[#FFD54F]' },
                  { icon: <User className="size-5" />, title: 'Build Your Team', desc: 'Recruit and manage service providers', gradient: 'from-[#FFD54F] to-[#E0B84C]' },
                  { icon: <FileText className="size-5" />, title: 'Flexible Hours', desc: 'Work on your own schedule with full support', gradient: 'from-[#E0B84C] to-[#FFD54F]' },
                ].map((item) => (
