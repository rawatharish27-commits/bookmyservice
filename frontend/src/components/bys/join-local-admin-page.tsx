...
const APPLICATION_FEE = 50; // ₹50 for Local Admin
...
const FAQ_ITEMS = [
  {
    question: 'What is the Local Admin role?',
    answer: 'A Local Admin is the bridge between the community and quality home services. You oversee local operations, verify service providers, handle customer concerns, and ensure service quality in your neighborhood. You earn commissions on bookings in your area.',
  },
  {
    question: 'How much is the application fee?',
    answer: `The application fee for the Local Admin position is ₹${APPLICATION_FEE}. This fee covers the administrative cost of processing your application, background verification, and onboarding setup.`,
  },
  {
  ...
  },
  {
    ...
    answer: 'The selection process involves evaluation of live tasks and performance assessment. We review your application, assess your community involvement and local knowledge, evaluate your communication and problem-solving skills, and observe your performance on assigned tasks. The process is competitive and merit-based.',
  },
  {
  ...
  },
  {
    ...
    answer: 'No. The Local Admin role is an independent contractor arrangement, not an employment relationship. You are free to manage your own schedule, but we expect a minimum commitment of hours to ensure quality service delivery in your area. There is no employer-employee relationship created by this arrangement.',
  },
  {
    question: 'What are the earning opportunities?',
    answer: 'As a Local Admin, you earn commissions on every booking in your designated area. Earnings depend on the volume of bookings in your territory. Additional incentives for quality assurance and customer satisfaction may also be available. Top-performing Local Admins earn consistent monthly income.',
  },
  {
    question: 'What happens after I\'m selected?',
    answer: 'After selection, you will undergo an onboarding process that includes training on our platform, operational guidelines, quality standards, and provider verification procedures. You will receive access to the Local Admin dashboard, be assigned your neighborhood territory, and can start verifying service providers in your area immediately.',
  },
];
...
const LEGAL_SECTIONS = [
  {
    ...
    content: [
      `The application fee for the Local Admin position is ₹${APPLICATION_FEE} (Indian Rupees Fifty Only).`,
  ...
  },
  {
    ...
    content: [
      ...
      'The Local Admin is not an employee of the company and is not entitled to any employee benefits including but not limited to: provident fund, ESI, gratuity, leave, or any other statutory benefits.',
      'The Local Admin is solely responsible for their own tax liabilities and compliance with applicable laws.',
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      `The company's total liability arising from or related to the application process is limited to the application fee amount (₹${APPLICATION_FEE}) only.`,
...
export function JoinLocalAdminPage() {
  ...
  const handlePayment = async () => {
    try {
      const applicationId = `APP-LA-${Date.now()}`;
        ...
        try {
          await mutate('/api/contact', {
            ...
            body: JSON.stringify({
              name: form.name,
              email: form.email,
              subject: 'Local Admin Application (Paid)',
      ...
      <motion.div {...fadeUp} transition={{ duration: 0.4 }}>
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage className="font-semibold text-[#FFD54F]">Join as Local Admin</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </motion.div>
      ...
      >
        ...
        <div className="relative text-center">
          ...
          <h1 className="mb-3 text-4xl font-bold text-white sm:text-5xl">
            Join as <span className="text-[#FFD54F]">Local Admin</span>
          </h1>
        ...
        <div className="flex items-start gap-4 p-5 sm:p-6">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-amber-800">
              A non-refundable application fee of <span className="font-bold">₹{APPLICATION_FEE}</span> is required to submit your Local Admin application.
        ...
        <div className="p-5 sm:p-6">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#0A1F44] to-[#132D5E] text-white shadow-md">
                <Scale className="size-5" />
              </div>
              <div>
                <h3 className="text-base font-bold text-[#0A1F44]">Terms & Conditions</h3>
                ...
                <div className="mt-5 space-y-5">
                  ...
                  {LEGAL_SECTIONS.map((section) => (
                    <div key={section.title} className="space-y-2">
                      <h4 className="flex items-center gap-2 text-sm font-bold text-[#0A1F44]">
                        <ChevronRight className="size-4 text-[#FFD54F]" />
                        {section.title}
                      </h4>
                      <ul className="ml-6 space-y-1.5">
                        {section.content.map((item, idx) => (
                          <li key={idx} className="flex items-start gap-2 text-sm text-muted-foreground">
                            <div className="mt-1.5 size-1.5 shrink-0 rounded-full bg-[#FFD54F]" />
                            <span>{item}</span>
                          </li>
                        ))}
                      </ul>
            ...
            <div className="bg-white p-6 sm:p-8">
              <AnimatePresence mode="wait">
                {step === 'success' ? (
                  ...
                  >
                    <div className="mx-auto mb-4 flex size-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#132D5E] to-[#FFD54F] text-white shadow-lg">
                      <CheckCircle2 className="size-8" />
                    </div>
                    <h3 className="text-2xl font-bold text-[#0A1F44]">Application Submitted!</h3>
                    ...
                    <Button
                      variant="outline"
                      className="mt-6 rounded-xl border-[#FFD54F] text-[#132D5E] hover:bg-[#E0B84C]/5"
                      onClick={() => {
                        setStep('form');
                  ...
                  >
                    <div className="mb-8 text-center">
                      <div className="mx-auto mb-4 flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#132D5E] to-[#FFD54F] text-white shadow-lg">
                        <CreditCard className="size-7" />
                      </div>
                      <h2 className="text-xl font-bold text-[#0A1F44]">Pay Application Fee</h2>
                    ...
                    <div className="mb-6 rounded-xl border border-gray-200 bg-gray-50/50 p-5">
                      <h4 className="mb-3 text-sm font-bold text-[#0A1F44]">Application Summary</h4>
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Name</span>
                          <span className="font-medium text-[#0A1F44]">{form.name}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Email</span>
                          <span className="font-medium text-[#0A1F44]">{form.email}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Phone</span>
                          <span className="font-medium text-[#0A1F44]">{form.phone}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">City</span>
                          <span className="font-medium text-[#0A1F44]">{form.city}</span>
                        </div>
                        <div className="h-px bg-gray-200 my-2" />
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Position</span>
                          <span className="font-medium text-[#0A1F44]">Local Admin</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="font-bold text-[#0A1F44]">Application Fee</span>
                          <span className="text-lg font-bold text-[#FFD54F]">₹{APPLICATION_FEE}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                      <Button
                        type="button"
                        variant="outline"
                        className="h-12 flex-1 rounded-xl border-[#FFD54F] text-[#132D5E] hover:bg-[#E0B84C]/5"
                        onClick={() => {
                          setStep('form');
                          setFormError(null);
                        }}
                      ...
                      <Button
                        ...
                        className="h-12 flex-1 rounded-xl bg-gradient-to-r from-[#0A1F44] via-[#132D5E] to-[#FFD54F] text-base font-medium text-white shadow-lg shadow-[#132D5E]/25 hover:from-[#0A1F44] hover:via-[#132D5E] hover:to-[#FFD54F]"
                      >
                  ...
                  >
                    <div className="mb-6 flex items-center gap-2">
                      <Button
                        ...
                        variant="ghost"
                        size="sm"
                        className="text-[#FFD54F] hover:bg-[#E0B84C]/5 hover:text-[#132D5E]"
                    ...
                    <h2 className="text-xl font-bold text-[#0A1F44]">Local Admin Application</h2>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            className="h-11 rounded-xl border-gray-200 bg-gray-50/50 pl-10 focus:border-[#FFD54F] focus:bg-white focus:ring-[#FFD54F]/30"
                          />
                        </div>
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="grid gap-5 sm:grid-cols-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select value={form.city} onValueChange={(v) => handleChange('city', v)}>
                          <SelectTrigger className="h-11 w-full rounded-xl border-gray-200 bg-gray-50/50 focus:border-[#FFD54F] focus:ring-[#FFD54F]/30">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Textarea
                          ...
                          className="rounded-xl border-gray-200 bg-gray-50/50 pl-10 focus:border-[#FFD54F] focus:bg-white focus:ring-[#FFD54F]/30"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative flex items-center justify-center rounded-xl border-2 border-dashed border-gray-200 bg-gray-50/50 p-8 transition-colors hover:border-[#FFD54F]/50 hover:bg-[#E0B84C]/5/30">
                        <input
                          type="file"
                        ...
                        <div className="text-center">
                          <Upload className="mx-auto size-8 text-[#FFD54F]/60" />
                          <p className="mt-2 text-sm font-medium text-[#0A1F44]">
                    ...
                    <div className="rounded-xl border border-gray-200 bg-gray-50/50 p-4">
                      <div className="flex items-start gap-3">
                        <Checkbox
                          ...
                          className="mt-0.5 data-[state=checked]:bg-[#FFD54F] data-[state=checked]:border-[#FFD54F]"
                        />
                        <div className="space-y-1">
                          <Label htmlFor="la-terms-agree" className="cursor-pointer text-sm font-medium leading-snug text-[#0A1F44]">
                    ...
                    <Button
                      type="submit"
                      disabled={loading}
                      className="h-12 w-full rounded-xl bg-gradient-to-r from-[#0A1F44] via-[#132D5E] to-[#FFD54F] text-base font-medium text-white shadow-lg shadow-[#132D5E]/25 hover:from-[#0A1F44] hover:via-[#132D5E] hover:to-[#FFD54F]"
                    >
        ...
        >
          ...
          <div className="overflow-hidden rounded-2xl border-0 shadow-lg">
            ...
            <div className="bg-white p-6">
              <h3 className="mb-5 text-lg font-bold text-[#0A1F44]">Why Become a Local Admin?</h3>
              <div className="space-y-4">
                {[
                  { icon: <ShieldCheck className="size-5" />, title: 'Community Leader', desc: 'Be the go-to person for local service quality', gradient: 'from-[#0A1F44] to-[#132D5E]' },
                  { icon: <Heart className="size-5" />, title: 'Help Your Neighbors', desc: 'Ensure reliable services reach your community', gradient: 'from-[#132D5E] to-[#FFD54F]' },
                  { icon: <Briefcase className="size-5" />, title: 'Earn Income', desc: 'Steady income from local booking commissions', gradient: 'from-[#FFD54F] to-[#E0B84C]' },
                  { icon: <FileText className="size-5" />, title: 'Verify Providers', desc: 'Ensure only trusted providers serve your area', gradient: 'from-[#E0B84C] to-[#FFD54F]' },
                ].map((item) => (
                  <div key={item.title} className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-[#0A1F44]">{item.title}</p>
          ...
          <div className="overflow-hidden rounded-2xl border-0 shadow-lg">
            <div className="bg-white p-6">
              <h3 className="mb-4 text-lg font-bold text-[#0A1F44]">Requirements</h3>
          ...
          <div className="overflow-hidden rounded-2xl border-0 shadow-lg">
            <div className="bg-white p-6">
              <h3 className="mb-4 text-lg font-bold text-[#0A1F44]">Application Process</h3>
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.step} className="flex items-center gap-3">
                    <div className="flex size-8 shrink-0 items-center justify-center rounded-lg bg-[#FFD54F]/10 text-[#FFD54F]">
                      {item.icon}
                    </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
          ...
          <div className="p-6 sm:p-8">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#0A1F44]">Frequently Asked Questions</h3>
            ...
            <Accordion type="single" collapsible className="w-full">
              {FAQ_ITEMS.map((faq, index) => (
                <AccordionItem key={index} value={`faq-${index}`}>
                  <AccordionTrigger className="text-sm font-semibold text-[#0A1F44] hover:text-[#FFD54F] hover:no-underline text-left">
                    {faq.question}
                  </AccordionTrigger>
