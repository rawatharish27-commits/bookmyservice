  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-6">
        <Button variant="ghost" size="sm" onClick={() => navigate('manager-dashboard')} className="mb-3 text-[#FFD54F] hover:text-[#132D5E] hover:bg-[#FFD54F]/5">
          <ArrowLeft className="mr-1 size-4" /> Back
        </Button>
        <h1 className="text-2xl font-bold text-[#0A1F44] sm:text-3xl">Manager Dashboard</h1>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-lg font-bold text-[#0A1F44]">{data.cityAnalytics.city}</p>
                </div>
                ...
                <div className="space-y-3">
                  {data.pendingProviders.map((provider) => (
                    <motion.div
                      ...
                      className="flex items-center gap-3 rounded-xl bg-[#0A1F44]/5 p-3"
                    >
                      <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#132D5E] to-[#FFD54F] text-[#0A1F44] shadow-md">
                      ...
                      <div className="flex shrink-0 gap-2">
                        <Button
                          size="sm"
                          className="h-8 rounded-lg bg-[#FFD54F] text-[#0A1F44] hover:bg-[#132D5E] hover:text-white"
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-xl bg-[#0A1F44]/5 p-4 text-center">
                  ...
                  <p className="mt-1 text-xl font-bold text-[#0A1F44]">₹{data.revenueTracking.today.toLocaleString()}</p>
                </div>
                <div className="rounded-xl bg-[#0A1F44]/5 p-4 text-center">
                  <p className="text-xs text-muted-foreground">This Week</p>
                  <p className="mt-1 text-xl font-bold text-[#0A1F44]">₹{(data.revenueTracking.thisWeek / 1000).toFixed(0)}k</p>
                </div>
                ...
                <div className="rounded-xl bg-[#FFD54F]/10 p-4 text-center">
                  ...
                  <p className="mt-1 text-xl font-bold text-[#132D5E]">₹{(data.revenueTracking.commissionEarned / 1000).toFixed(0)}k</p>
                </div>
              </div>
              ...
              <ScrollArea className="max-h-72">
                <div className="space-y-3">
                  {data.activeTechnicians.map((tech) => (
                    <div key={tech.id} className="flex items-center gap-3 rounded-xl bg-[#0A1F44]/5 p-3">
                      <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#FFD54F] to-[#E0B84C] text-[#0A1F44] shadow-md">
