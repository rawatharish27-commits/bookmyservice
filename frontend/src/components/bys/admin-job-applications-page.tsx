...
function StatusBadge({ status }: { status: ApplicationStatus }) {
  const config: Record<ApplicationStatus, { label: string; className: string }> = {
    ...
    UNDER_REVIEW: {
      label: 'Under Review',
      className: 'bg-[#FFD54F]/10 text-[#132D5E] border-[#FFD54F]/20',
    },
    APPROVED: {
      label: 'Approved',
      className: 'bg-[#FFD54F]/10 text-[#132D5E] border-[#FFD54F]/30',
    },
    REJECTED: {
      label: 'Rejected',
...
function PositionBadge({ position }: { position: 'area-manager' | 'local-admin' }) {
  return position === 'area-manager' ? (
    ...
    <Badge variant="outline" className="bg-[#FFD54F]/10 text-[#132D5E] border-[#FFD54F]/30 font-medium">
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      >
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#0A1F44] via-[#132D5E] to-[#FFD54F]">
        ...
        <Button
          variant="outline"
          className="gap-2 border-[#FFD54F] text-[#132D5E] hover:bg-[#FFD54F]/5"
                        ...
                        <AnimatePresence>
                          {applications.map((app, index) => (
                            ...
                            >
                              <TableCell>
                                <div className="flex items-center gap-3">
                                  <div className="flex size-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-[#0A1F44] to-[#132D5E] text-white text-sm font-bold">
                                ...
                                <div className="flex items-center justify-end gap-1">
                                  ...
                                  {app.status === 'PENDING' && (
                                    <Button
                                      variant="ghost"
                                      size="sm"
                                      className="size-8 p-0 text-[#FFD54F] hover:bg-[#FFD54F]/5 hover:text-[#FFD54F]"
                                  ...
                                  {app.status !== 'APPROVED' && (
                                    <Button
                                      variant="ghost"
                                      size="sm"
                                      className="size-8 p-0 text-[#FFD54F] hover:bg-[#FFD54F]/10 hover:text-[#132D5E]"
                                      title="Approve"
                                      disabled={actionLoading === app.id}
                                      onClick={() =>
          ...
          >
            ...
            >
              ...
              <div className="relative overflow-hidden">
                <div className="h-2 bg-gradient-to-r from-[#0A1F44] via-[#132D5E] to-[#FFD54F]" />
                <div className="bg-gradient-to-br from-[#0A1F44] via-[#132D5E] to-[#FFD54F] px-6 pb-6 pt-8 text-white">
                  <button
                    onClick={() => setDetailApp(null)}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="truncate text-sm text-[#F2C94C]">{detailApp.email}</p>
                      <div className="mt-2">
              ...
              <div className="border-t bg-gray-50 p-4">
                <div className="flex flex-wrap gap-2">
                  {detailApp.status === 'PENDING' && (
                    <Button
                      className="flex-1 gap-2 bg-[#FFD54F] text-[#0A1F44] hover:bg-[#132D5E] hover:text-white"
