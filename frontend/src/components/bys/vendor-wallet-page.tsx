...
const CATEGORY_CONFIG: Record<string, { icon: typeof Wallet; gradient: string; label: string }> = {
  TOP_UP: { icon: Plus, gradient: 'from-[#FFD54F] to-[#E0B84C]', label: 'Top Up' },
  BOOKING: { icon: CreditCard, gradient: 'from-[#E0B84C] to-[#FFD54F]', label: 'Booking' },
  EARNING: { icon: TrendingUp, gradient: 'from-[#FFD54F] to-[#E0B84C]', label: 'Earning' },
  CASHBACK: { icon: Gift, gradient: 'from-[#FFD54F] to-[#E0B84C]', label: 'Cashback' },
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center gap-2">
                              ...
                              <Badge variant="outline" className={`shrink-0 gap-1 text-[10px] font-semibold ${
                                isCredit ? 'border-[#FFD54F]/30 bg-[#FFD54F]/10 text-[#132D5E]' : 'border-rose-200 bg-rose-50 text-rose-700'
                              }`}>
          ...
          {withdrawSuccess ? (
            <>
              ...
              <div className="flex flex-col items-center py-8 text-center">
                <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring', stiffness: 200, damping: 15 }} className="flex size-20 items-center justify-center rounded-full bg-[#FFD54F]/10">
