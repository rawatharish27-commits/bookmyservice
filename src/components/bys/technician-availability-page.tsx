...
export function TechnicianAvailabilityPage() {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-[#0A1F44]">Availability</h1>
        <p className="max-w-md text-muted-foreground">Set your working hours and availability.</p>
