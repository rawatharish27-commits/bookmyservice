  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-[#0A1F44]">Technician Dashboard</h1>
        <p className="max-w-md text-muted-foreground">Manage your assigned jobs and availability.</p>
