...
export function EmergencyBookingPage() {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-[#0a1628]">Emergency Booking</h1>
        <p className="max-w-md text-muted-foreground">Book an emergency service request.</p>
