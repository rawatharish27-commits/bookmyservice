  ...
  return (
    <AnimatePresence mode="wait">
      <motion.span
        ...
        className="inline-block bg-gradient-to-r from-[#FFD54F] via-[#E0B84C] to-[#FFD54F] bg-clip-text text-transparent"
        style={{ textShadow: '0 0 40px rgba(10,31,68,0.5), 0 0 80px rgba(212,160,23,0.25)' }}
      >
        {words[index]}
      </motion.span>
    </AnimatePresence>
    ...
    <div className="relative mx-auto max-w-3xl">
      <AnimatePresence mode="wait">
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(242,201,76,0.9) 0%, rgba(212,160,23,0.8) 40%, rgba(224,184,76,0.7) 70%, rgba(242,201,76,0.95) 100%)',
            backdropFilter: 'blur(20px)',
            border: '1px solid rgba(10,31,68,0.12)',
          }}
        >
          <div className="pointer-events-none absolute -right-12 -top-12 size-40 rounded-full bg-gradient-to-br from-[#132D5E]/10 to-[#FFD54F]/10 blur-2xl" />
          <div className="pointer-events-none absolute -bottom-12 -left-12 size-40 rounded-full bg-gradient-to-br from-[#FFD54F]/15 to-[#132D5E]/5 blur-2xl" />
          <div className="relative">
            <div className="mx-auto mb-5 flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#132D5E]/10 to-[#D4A017]/10">
            ...
            <div className="flex items-center justify-center gap-4">
              <div className="flex size-14 items-center justify-center rounded-full bg-gradient-to-br from-[#0A1F44] via-[#132D5E] to-[#D4A017] text-base font-bold text-white shadow-lg shadow-[#132D5E]/30 ring-2 ring-[#FFD54F]/50">
                {t.avatar}
              </div>
              ...
              <Badge className="ml-2 border-[#132D5E]/20 bg-gradient-to-r from-[#0A1F44]/5 to-[#D4A017]/5 px-3 py-1 text-[#132D5E]" variant="outline">
                {t.service}
              </Badge>
            </div>
          </div>
      ...
      <div className="mt-8 flex items-center justify-center gap-5">
        <button onClick={prev} className="group flex size-11 items-center justify-center rounded-full border border-[#132D5E]/20 bg-[#F2C94C] text-[#0A1F44] shadow-sm transition-all duration-300 hover:bg-[#0A1F44]/5 hover:shadow-md hover:scale-110" aria-label="Previous testimonial">
          <ChevronLeft className="size-5 transition-transform group-hover:-translate-x-0.5" />
        </button>
        <div className="flex gap-2.5">
          {testimonials.map((_, idx) => (
            <button key={idx} onClick={() => { setCurrent(idx); setAutoPlay(false); }} className={`h-3 rounded-full transition-all duration-400 ${idx === current ? 'w-10 bg-gradient-to-r from-[#0A1F44] to-[#D4A017] shadow-md shadow-[#132D5E]/30' : 'w-3 bg-[#132D5E]/20 hover:bg-[#132D5E]/30 hover:scale-125'}`} aria-label={`Go to testimonial ${idx + 1}`} />
          ))}
        </div>
        <button onClick={next} className="group flex size-11 items-center justify-center rounded-full border border-[#132D5E]/20 bg-[#F2C94C] text-[#0A1F44] shadow-sm transition-all duration-300 hover:bg-[#0A1F44]/5 hover:shadow-md hover:scale-110" aria-label="Next testimonial">
...
export function HomePage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #0A1F44 0%, #132D5E 50%, #D4A017 100%)' }}>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center sm:gap-8">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="flex items-center gap-3">
              ...
              <p className="text-sm font-medium text-[#E0B84C]">
                <span className="font-bold text-white">First 100 Clients</span> — Get FREE Subscription for 1 Year!
              </p>
            </motion.div>
            <div className="hidden h-4 w-px bg-[#FFD54F]/20 sm:block" />
      ...
      <section className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #0A1F44 0%, #132D5E 25%, #D4A017 50%, #132D5E 75%, #0A1F44 100%)' }}>
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute -left-40 -top-40 size-[800px] rounded-full bg-gradient-to-br from-[#D4A017]/30 to-[#FFD54F]/15 blur-3xl" />
          <div className="absolute -bottom-20 -right-20 size-[700px] rounded-full bg-gradient-to-tl from-[#132D5E]/25 to-[#D4A017]/10 blur-3xl" />
          ...
          <motion.div className="absolute -bottom-10 right-10 size-72 rounded-full bg-[#D4A017]/[0.06]" animate={{ x: [0, -40, 0], y: [0, 40, 0] }} transition={{ duration: 10, repeat: Infinity, ease: 'easeInOut' }} />
          {Array.from({ length: 20 }).map((_, i) => {
            const seed = (i * 2654435761) >>> 0;
            return (
              <motion.div
                key={`p-${i}`}
                className="absolute rounded-full bg-[#FFD54F]/[0.08]"
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
              <motion.div variants={fadeUp} custom={0}>
                <Badge className="mb-6 border-[#FFD54F]/20 bg-[#132D5E]/50 px-5 py-2 text-[#FFD54F] hover:bg-[#132D5E]/60 text-sm">
              ...
              <motion.h1 variants={fadeUp} custom={1} className="text-4xl font-extrabold leading-[1.1] tracking-tight text-white sm:text-5xl lg:text-6xl">
                ...
                <br />
                <span className="bg-gradient-to-r from-[#FFD54F] via-[#E0B84C] to-[#FFD54F] bg-clip-text text-transparent" style={{ textShadow: '0 0 40px rgba(10,31,68,0.5)' }}>at Your Doorstep</span>
              </motion.h1>

              <motion.p variants={fadeUp} custom={2} className="mt-6 max-w-xl text-lg leading-relaxed text-[#E0B84C]/70">
              ...
              <motion.div variants={fadeUp} custom={3} className="mt-5 flex items-center gap-2.5">
                ...
                {locationLoading ? (
                  <span className="text-sm text-[#E0B84C]">📍 Detecting your location...</span>
                ) : location ? (
                  <span className="text-sm text-[#E0B84C]">📍 {location.city}{location.state ? `, ${location.state}` : ''}</span>
                ) : (
                  <span className="text-sm text-[#E0B84C]/70">📍 Location unavailable</span>
                )}
                ...
                <span className="text-sm font-medium text-[#E0B84C]">
              ...
              <motion.div variants={fadeUp} custom={4} className="mt-8 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
                <Button size="lg" onClick={() => navigate('categories')} className="group h-13 bg-[#FFD54F] px-10 text-base font-bold text-[#0A1F44] shadow-xl shadow-[#FFD54F]/30 hover:bg-[#FFD54F]/90 hover:shadow-2xl hover:shadow-[#FFD54F]/40">
                  Book a Service <ArrowRight className="ml-2 size-5 transition-transform group-hover:translate-x-1" />
                </Button>
                {!user && (
                  <>
                    <Button size="lg" onClick={() => navigate('login')} className="h-13 border-2 border-[#FFD54F]/40 bg-[#132D5E]/30 px-8 text-base text-white shadow-lg backdrop-blur-sm hover:border-[#FFD54F]/60 hover:bg-[#132D5E]/40">
                      Client Login
                    </Button>
                    <Button size="lg" variant="outline" onClick={() => navigate('register')} className="h-13 border-[#D4A017]/40 text-base text-[#E0B84C] hover:bg-[#132D5E]/15 hover:border-[#D4A017]/60">
                      Join as Provider
                    </Button>
                  </>
                )}
                {user && user.role === 'CLIENT' && (
                  <Button size="lg" onClick={() => navigate('client-dashboard')} className="h-13 border-2 border-[#FFD54F]/40 bg-[#132D5E]/30 px-8 text-base text-white shadow-lg backdrop-blur-sm hover:border-[#FFD54F]/60">
                    My Dashboard
                  </Button>
                )}
                {user && user.role === 'PROVIDER' && (
                  <Button size="lg" onClick={() => navigate('provider-dashboard')} className="h-13 border-2 border-[#D4A017]/40 bg-[#132D5E]/30 px-8 text-base text-white shadow-lg backdrop-blur-sm hover:border-[#D4A017]/60">
                    Provider Dashboard
                  </Button>
                )}
              </motion.div>
            ...
            <motion.div className="hidden lg:flex lg:items-center lg:justify-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
              <div className="relative flex size-[400px] items-center justify-center">
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#D4A017]/15 to-[#FFD54F]/8 blur-3xl" />
                <motion.div className="absolute inset-4 rounded-full border border-[#FFD54F]/[0.08]" animate={{ rotate: 360 }} transition={{ duration: 60, repeat: Infinity, ease: 'linear' }} />
                <div className="absolute inset-12 rounded-full border border-[#FFD54F]/[0.05]" />

                {/* Floating service icons */}
                <motion.div className="absolute -left-4 top-4" animate={{ y: [0, -20, 0] }} transition={{ duration: 3.5, repeat: Infinity, ease: 'easeInOut' }}>
                  <div className="flex size-24 items-center justify-center rounded-3xl bg-gradient-to-br from-[#132D5E]/40 to-[#FFD54F]/20 shadow-2xl shadow-[#132D5E]/25 backdrop-blur-xl ring-1 ring-[#FFD54F]/20">
                    <Wind className="size-10 text-[#FFD54F] drop-shadow-[0_0_12px_rgba(255,213,79,0.6)]" />
                  </div>
                </motion.div>
                <motion.div className="absolute right-0 top-16" animate={{ y: [0, 18, 0] }} transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}>
                  <div className="flex size-24 items-center justify-center rounded-3xl bg-gradient-to-br from-[#0A1F44]/30 to-[#D4A017]/15 shadow-2xl shadow-[#0A1F44]/25 backdrop-blur-xl ring-1 ring-[#FFD54F]/20">
                    <Wrench className="size-10 text-[#FFD54F] drop-shadow-[0_0_12px_rgba(224,184,76,0.6)]" />
                  </div>
                </motion.div>
                <motion.div className="absolute bottom-4 left-1/2 -translate-x-1/2" animate={{ y: [0, -15, 0] }} transition={{ duration: 4.5, repeat: Infinity, ease: 'easeInOut' }}>
                  <div className="flex size-24 items-center justify-center rounded-3xl bg-gradient-to-br from-[#D4A017]/30 to-[#132D5E]/15 shadow-2xl shadow-[#D4A017]/25 backdrop-blur-xl ring-1 ring-[#FFD54F]/20">
                    <Zap className="size-10 text-[#FFD54F] drop-shadow-[0_0_12px_rgba(212,160,23,0.6)]" />
                  </div>
                </motion.div>

                <div className="rounded-3xl bg-[#FFD54F]/10 px-8 py-5 text-center shadow-2xl backdrop-blur-xl ring-1 ring-[#FFD54F]/20">
                  <Home className="mx-auto mb-2 size-7 text-[#FFD54F]/80" />
                  <p className="text-xl font-bold text-white">Your Home</p>
                  <p className="text-sm font-medium text-[#E0B84C]/80">Our Expertise</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full">
            <path d="M0 100V50C180 80 360 20 540 50C720 80 900 20 1080 50C1260 80 1350 35 1440 50V100H0Z" fill="#F2C94C" fillOpacity="0.95" />
          </svg>
        </div>
      </section>

      {/* ═══════════ 3. Location Bar ═══════════ */}
      <section className="relative z-10 -mt-2 bg-[#F2C94C]">
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="flex flex-col items-center gap-4 rounded-2xl border border-[#132D5E]/10 bg-gradient-to-r from-[#0A1F44]/5 via-[#F2C94C] to-[#D4A017]/5 p-4 shadow-sm sm:flex-row sm:justify-between"
          >
            <div className="flex items-center gap-3">
              <div className="flex size-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#0A1F44] to-[#D4A017] text-white shadow-md">
            ...
            <div className="flex items-center gap-2">
              <Input
                ...
                className="h-9 w-36 border-[#132D5E]/20 text-sm focus-visible:border-[#D4A017] focus-visible:ring-[#D4A017]/20"
              />
              <Button onClick={handlePincodeLookup} size="sm" className="bg-[#FFD54F] text-[#0A1F44] hover:bg-[#FFD54F]/90">
                Check
              </Button>
            </div>
          </motion.div>
      ...
      <section className="bg-[#F2C94C] py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <button
              onClick={scrollLeft}
              className="absolute left-0 top-1/2 z-20 -translate-y-1/2 flex size-11 items-center justify-center rounded-full border border-[#132D5E]/20 bg-[#F2C94C] text-[#0A1F44] shadow-lg transition-all hover:bg-[#0A1F44] hover:text-white hover:shadow-xl hover:scale-110"
            ...
            <button
              onClick={scrollRight}
              className="absolute right-0 top-1/2 z-20 -translate-y-1/2 flex size-11 items-center justify-center rounded-full border border-[#132D5E]/20 bg-[#F2C94C] text-[#0A1F44] shadow-lg transition-all hover:bg-[#0A1F44] hover:text-white hover:shadow-xl hover:scale-110"
                  ...
                  >
                    <TiltCard>
                      ...
                      >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-b from-[#132D5E] to-[#0A1F44] -z-10" />

                        {/* Icon overlay */}
                        <div className="absolute top-4 left-4 z-10 flex size-12 items-center justify-center rounded-xl bg-[#FFD54F]/20 text-white backdrop-blur-md ring-1 ring-[#FFD54F]/25 shadow-lg">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 z-10 p-4">
                          ...
                          <p className="mt-1 text-xs text-[#E0B84C]/90 leading-relaxed">{service.description}</p>
                          {isAvailable ? (
                            <div className="mt-2 flex items-center gap-1 text-xs text-[#FFD54F] font-semibold">
                              <span>View Services</span>
                              <ArrowRight className="size-3 transition-transform group-hover:translate-x-1" />
                            </div>
                          ) : (
                            <Badge className="mt-2 bg-[#FFD54F]/20 text-[#FFD54F] border-[#FFD54F]/30 backdrop-blur-sm px-3 py-0.5 text-[10px] font-semibold">
                              Coming Soon
                            </Badge>
                          )}
                        </div>
                        ...
                        {!isAvailable && (
                          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-[#0A1F44]/50 backdrop-blur-[2px]">
                            <Badge className="bg-[#132D5E]/80 text-[#FFD54F] border-[#D4A017]/30 backdrop-blur-sm px-4 py-1.5 text-sm font-semibold">
                              Coming Soon
                            </Badge>
                            <p className="mt-2 text-xs text-[#E0B84C]/70">In Your Area</p>
                          </div>
                        )}
                      </div>
                    </TiltCard>
      ...
      <section className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #0A1F44 0%, #132D5E 100%)' }}>
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -right-20 -top-20 size-60 rounded-full bg-[#D4A017]/15 blur-3xl" />
          <div className="absolute -bottom-20 -left-20 size-60 rounded-full bg-[#FFD54F]/10 blur-3xl" />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center">
            <div className="mx-auto mb-4 flex size-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#FFD54F]/20 to-[#D4A017]/20 ring-1 ring-[#FFD54F]/15">
              <Rocket className="size-8 text-[#FFD54F]" />
            </div>
            <h2 className="text-2xl font-extrabold text-white sm:text-3xl">
              🚀 {location?.city || 'Your City'} Area Launch Progress
            </h2>
            <p className="mt-2 text-[#E0B84C]/60">Help us launch faster — join as a provider or refer one!</p>
          </motion.div>
          ...
          <motion.div
            ...
            className="mx-auto mt-10 max-w-xl rounded-3xl bg-[#FFD54F]/5 p-8 backdrop-blur-sm ring-1 ring-[#FFD54F]/15 shadow-2xl"
          >
            {/* Providers Progress */}
            <div className="mb-6">
              <div className="mb-2 flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-[#FFD54F]">
                  {areaProviders}/20 <span className="text-[#E0B84C]/50 font-normal">({Math.round((areaProviders / 20) * 100)}%)</span>
                </span>
              </div>
              <div className="relative h-3 w-full overflow-hidden rounded-full bg-[#FFD54F]/10">
                <motion.div
                  className="absolute left-0 top-0 h-full rounded-full bg-gradient-to-r from-[#132D5E] to-[#D4A017]"
                  initial={{ width: 0 }}
            ...
            <div className="mb-6">
              <div className="mb-2 flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-[#FFD54F]">
                  {areaCustomers}/100 <span className="text-[#E0B84C]/50 font-normal">({Math.round((areaCustomers / 100) * 100)}%)</span>
                </span>
              </div>
              <div className="relative h-3 w-full overflow-hidden rounded-full bg-[#FFD54F]/10">
                <motion.div
                  className="absolute left-0 top-0 h-full rounded-full bg-gradient-to-r from-[#D4A017] to-[#FFD54F]"
                  initial={{ width: 0 }}
            ...
            {/* Milestone markers */}
            <div className="flex items-center justify-between border-t border-[#FFD54F]/15 pt-4 text-xs text-[#E0B84C]/50">
              <span>🚀 Launching</span>
      ...
      <section className="bg-[#F2C94C] py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {hasProvidersInArea ? (
              ...
              {servicesLoading ? (
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {services.slice(0, 6).map((service, idx) => (
                    ...
                    >
                      <TiltCard>
                        <Card className="group cursor-pointer overflow-hidden rounded-2xl border-[#132D5E]/10 shadow-sm transition-all hover:shadow-xl hover:border-[#D4A017]/20" onClick={() => navigate('service-detail', { id: service.id })}>
                          <div className="relative overflow-hidden">
                            {service.images ? (
                              ...
                              <div className="aspect-video w-full bg-gradient-to-br from-[#132D5E]/20 to-[#D4A017]/10 flex items-center justify-center">
                                <Wrench className="size-12 text-[#132D5E]/30" />
                              </div>
                            )}
                            <Badge className="absolute top-3 right-3 bg-[#0A1F44]/80 text-[#FFD54F] backdrop-blur-sm border-[#D4A017]/30">
            ...
            <>
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-10 text-center">
                <div className="mx-auto mb-4 flex size-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#132D5E]/10 to-[#D4A017]/10">
              ...
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2, duration: 0.6 }} className="mx-auto grid max-w-3xl gap-4 sm:grid-cols-2">
                <Card className="group cursor-pointer border-[#132D5E]/10 rounded-2xl transition-all hover:shadow-xl hover:border-[#D4A017]/20" onClick={() => navigate('register', { role: 'PROVIDER' })}>
                  <CardContent className="flex flex-col items-center p-6 text-center">
                    <div className="mb-3 flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#0A1F44] to-[#D4A017] text-white shadow-lg shadow-[#132D5E]/20">
                    ...
                    <Button className="mt-4 bg-[#FFD54F] text-[#0A1F44] hover:bg-[#FFD54F]/90">
                      Join Now <ArrowRight className="ml-1 size-4" />
                    </Button>
                  </CardContent>
                </Card>

                <Card className="group cursor-pointer border-[#132D5E]/10 rounded-2xl transition-all hover:shadow-xl hover:border-[#D4A017]/20" onClick={openWhatsAppReferral}>
                  <CardContent className="flex flex-col items-center p-6 text-center">
                ...
                <Card className="group cursor-pointer border-[#132D5E]/10 rounded-2xl transition-all hover:shadow-xl hover:border-[#D4A017]/20" onClick={() => navigate('register', { role: 'AREA_MANAGER' })}>
                  <CardContent className="flex flex-col items-center p-6 text-center">
                    <div className="mb-3 flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#132D5E] to-[#FFD54F] text-white shadow-lg shadow-[#132D5E]/20">
                    ...
                    <Button className="mt-4 bg-gradient-to-r from-[#132D5E] to-[#FFD54F] text-white hover:from-[#132D5E] hover:to-[#FFD54F]">
                      Apply Now <ArrowRight className="ml-1 size-4" />
                    </Button>
                  </CardContent>
                </Card>

                <Card className="group cursor-pointer border-[#132D5E]/10 rounded-2xl transition-all hover:shadow-xl hover:border-[#D4A017]/20">
                  <CardContent className="flex flex-col items-center p-6 text-center">
                    ...
                    <Button variant="outline" className="mt-4 border-[#132D5E]/20 text-[#132D5E] hover:bg-[#0A1F44]/5">
      ...
      <section className="bg-gradient-to-b from-[#0A1F44]/5 to-[#F2C94C] py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                <TiltCard>
                  <div className="relative overflow-hidden rounded-2xl border border-[#132D5E]/10 bg-[#F2C94C] p-6 shadow-sm transition-all hover:shadow-xl hover:border-[#D4A017]/20 text-center">
                    <div className="absolute -right-3 -top-3 text-6xl font-black text-[#132D5E]/5">{item.step}</div>
                    <div className="mx-auto mb-4 flex size-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#0A1F44] to-[#D4A017] text-white shadow-lg shadow-[#132D5E]/20">
                      {item.icon}
                    </div>
      ...
      <section className="relative overflow-hidden py-16" style={{ background: 'linear-gradient(135deg, #D4A017 0%, #C99700 50%, #F2C94C 100%)' }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-12 text-center">
            <div className="mx-auto mb-4 flex size-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#0A1F44] to-[#D4A017] text-white shadow-lg shadow-[#132D5E]/20">
          ...
          <div className="mx-auto grid max-w-4xl gap-6 sm:grid-cols-2">
            ...
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <TiltCard>
                <Card className="h-full overflow-hidden rounded-2xl border-[#132D5E]/10 shadow-sm transition-all hover:shadow-xl hover:border-[#D4A017]/20">
                  <div className="h-2 bg-gradient-to-r from-[#0A1F44] to-[#D4A017]" />
                  <CardContent className="p-6">
                    <div className="mb-4 flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#0A1F44] to-[#D4A017] text-white shadow-lg shadow-[#132D5E]/20">
                      <Shield className="size-7" />
                    </div>
                    <h3 className="text-xl font-bold text-[#0A1F44]">Area Manager</h3>
                    <p className="mt-1 text-sm text-[#D4A017] font-medium">Local Operations Leader</p>
                    <ul className="mt-4 space-y-2">
                      {['Local providers onboarding', 'Customer acquisition', 'Local operations management', 'Community building'].map((item) => (
                        <li key={item} className="flex items-center gap-2 text-sm text-muted-foreground">
                          <CheckCircle2 className="size-4 text-[#D4A017] flex-shrink-0" /> {item}
                        </li>
                      ))}
                    </ul>
                    <Button onClick={() => navigate('register', { role: 'AREA_MANAGER' })} className="mt-6 w-full bg-[#FFD54F] text-[#0A1F44] hover:bg-[#FFD54F]/90">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <TiltCard>
                <Card className="h-full overflow-hidden rounded-2xl border-[#132D5E]/10 shadow-sm transition-all hover:shadow-xl hover:border-[#D4A017]/20">
                  <div className="h-2 bg-gradient-to-r from-[#132D5E] to-[#FFD54F]" />
                  <CardContent className="p-6">
                    <div className="mb-4 flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#132D5E] to-[#FFD54F] text-white shadow-lg shadow-[#132D5E]/20">
                      <ThumbsUp className="size-7" />
                    </div>
                    <h3 className="text-xl font-bold text-[#0A1F44]">Local Admin</h3>
                    <p className="mt-1 text-sm text-[#D4A017] font-medium">Support & Quality Champion</p>
                    <ul className="mt-4 space-y-2">
                    ...
                    <Button onClick={() => navigate('register', { role: 'SUB_ADMIN' })} className="mt-6 w-full bg-gradient-to-r from-[#132D5E] to-[#FFD54F] text-white hover:from-[#132D5E] hover:to-[#FFD54F]">
      ...
      {/* ═══════════ 10. Referral Section ═══════════ */}
      <section className="relative overflow-hidden py-16" style={{ background: 'linear-gradient(135deg, #0A1F44 0%, #132D5E 50%, #D4A017 100%)' }}>
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -right-20 top-0 size-80 rounded-full bg-[#FFD54F]/10 blur-3xl" />
          <div className="absolute -bottom-20 -left-20 size-80 rounded-full bg-[#D4A017]/15 blur-3xl" />
        </div>

        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-4xl items-center gap-10 lg:grid-cols-2">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <div className="flex size-16 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-400/20 to-emerald-600/20 ring-1 ring-[#FFD54F]/15">
              ...
              <p className="mt-4 text-lg text-[#E0B84C]/70 leading-relaxed">
              ...
              <div className="mt-6 flex items-center gap-4 rounded-2xl bg-[#FFD54F]/5 p-4 ring-1 ring-[#FFD54F]/10 backdrop-blur-sm">
                <div className="flex size-12 items-center justify-center rounded-xl bg-gradient-to-br from-amber-400 to-amber-300 text-[#0A1F44] font-bold shadow-lg shadow-amber-400/20">
                  5%
                </div>
                <div>
                  <p className="font-bold text-white">Referral Commission</p>
                  <p className="text-sm text-[#E0B84C]/60">On every booking from your referral</p>
                </div>
              </div>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <Card className="overflow-hidden rounded-2xl border-[#FFD54F]/15 bg-[#FFD54F]/5 backdrop-blur-sm shadow-2xl">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={item.step} className="flex items-start gap-3">
                        <div className="flex size-8 flex-shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-[#132D5E] to-[#D4A017] text-sm font-bold text-white">
                          {item.step}
                        </div>
                        <div>
                          <p className="font-semibold text-white text-sm">{item.title}</p>
                          <p className="text-xs text-[#E0B84C]/60">{item.desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        <DialogContent className="max-w-md rounded-3xl border-[#132D5E]/20 p-0 overflow-hidden" showCloseButton={false}>
          <div className="relative">
            ...
            <div className="px-6 pt-8 pb-6" style={{ background: 'linear-gradient(135deg, #0A1F44 0%, #132D5E 100%)' }}>
              <button onClick={() => closePopup(false)} className="absolute right-4 top-4 flex size-8 items-center justify-center rounded-full bg-[#FFD54F]/10 text-white/70 hover:bg-[#FFD54F]/20 hover:text-white transition-colors">
                <X className="size-4" />
              </button>

              <div className="flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#FFD54F]/20 to-[#D4A017]/20 ring-1 ring-[#FFD54F]/15 mx-auto">
            ...
            <div className="px-6 pb-6 pt-4">
              ...
              <div className="mb-5 rounded-2xl bg-[#0A1F44]/5 p-4">
                ...
                <div className="space-y-2">
                  ...
                  <Progress value={(areaProviders / 20) * 100} className="h-2 bg-[#132D5E]/10 [&>div]:bg-gradient-to-r [&>div]:from-[#0A1F44] [&>div]:to-[#D4A017]" />
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-muted-foreground">Customers</span>
                    <span className="font-bold text-[#132D5E]">{areaCustomers}/100</span>
                  </div>
                  <Progress value={(areaCustomers / 100) * 100} className="h-2 bg-[#132D5E]/10 [&>div]:bg-gradient-to-r [&>div]:from-[#D4A017] [&>div]:to-[#FFD54F]" />
                </div>
              </div>
              ...
              <div className="space-y-3">
                {!hasProvidersInArea && (
                  <>
                    <Button onClick={() => { closePopup(false); navigate('register', { role: 'PROVIDER' }); }} className="w-full bg-[#FFD54F] text-[#0A1F44] hover:bg-[#FFD54F]/90">
                    ...
                    <Button onClick={() => { closePopup(false); navigate('register', { role: 'AREA_MANAGER' }); }} className="w-full bg-gradient-to-r from-[#132D5E] to-[#FFD54F] text-white hover:from-[#132D5E] hover:to-[#FFD54F]">
                ...
                {hasProvidersInArea && !hasLimitedServices && (
                  <Button onClick={() => { closePopup(false); navigate('categories'); }} className="w-full bg-[#FFD54F] text-[#0A1F44] hover:bg-[#FFD54F]/90">
              ...
              <label className="mt-4 flex items-center gap-2 text-xs text-muted-foreground cursor-pointer">
                <input
                  ...
                  className="rounded border-[#132D5E]/20 text-[#132D5E] focus:ring-[#D4A017]/20"
                />
