    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-2xl space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button className="gap-1 bg-blue-600 hover:bg-blue-700 rounded-xl" aria-label="Download invoice"><Download className="size-4" /> Download</Button>
        </div>
        ...
        <Card className="bg-white rounded-xl">
          <CardContent className="p-6 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <Separator />
              <div className="flex justify-between text-base font-bold"><span className="text-slate-900">Total</span><span className="text-blue-600">{invoice.total}</span></div>
            </div>
          </CardContent>
        </Card>
      </div>
