    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        <Card className="bg-white rounded-xl">
          ...
          <CardContent>
            <div className="flex items-center gap-3">
              <Avatar><AvatarFallback className="bg-[#0A1F44] text-white text-sm">{booking.provider.initials}</AvatarFallback></Avatar>
        ...
        <div className="flex gap-3">
          ...
          <Button className="flex-1 bg-[#0A1F44] hover:bg-[#0A1F44]/90 text-white rounded-xl gap-1" onClick={() => navigate('client-invoice', { id: booking.id })} aria-label="View invoice"><Receipt className="size-4" /> View Invoice</Button>
        </div>
      </div>
    </div>
  )
