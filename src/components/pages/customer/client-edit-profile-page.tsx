        ...
        <Card className="bg-white rounded-xl">
          <CardContent className="p-6">
            <div className="flex flex-col items-center gap-3 mb-6">
              <div className="relative">
                <Avatar className="size-24">
                  <AvatarFallback className="bg-blue-600 text-white text-2xl">{profile?.initials ?? 'U'}</AvatarFallback>
                </Avatar>
            ...
            <div className="mt-6 flex gap-3">
              <Button className="flex-1 bg-blue-600 hover:bg-blue-700 gap-1 rounded-xl" onClick={handleSave} disabled={saving} aria-label="Save changes">
