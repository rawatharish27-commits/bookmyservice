    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-2xl space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button size="sm" className="gap-1 bg-[#0A1F44] hover:bg-[#0A1F44]/90 text-white rounded-xl" aria-label="Add new address">
        ...
        {!addresses || addresses.length === 0 ? (
          <div className="text-center py-12">
            ...
            <Button className="mt-4 bg-[#0A1F44] hover:bg-[#0A1F44]/90 text-white gap-1" aria-label="Add your first address">
              <Plus className="size-4" /> Add Address
            </Button>
          </div>
        ) : (
                ...
                <Card key={addr.id} className="bg-white rounded-xl">
                  <CardContent className="p-5">
                    <div className="flex items-start gap-3">
                      <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-[#FFD54F]/10">
                        <IconComponent className="size-5 text-[#0A1F44]" />
                      </div>
                      ...
                      <div className="flex gap-1">
                        <Button variant="ghost" size="icon" className="size-8 text-slate-400 hover:text-[#0A1F44]" aria-label={`Edit ${addr.label} address`}><Edit className="size-4" /></Button>
