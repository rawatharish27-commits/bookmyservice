    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-2xl space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button size="sm" className="gap-1 bg-blue-600 hover:bg-blue-700 rounded-xl" aria-label="Add new payment method"><Plus className="size-4" /> Add New</Button>
        </div>
            ...
            {(!paymentData?.cards || paymentData.cards.length === 0) ? (
              ...
              paymentData.cards.map((c) => (
                <div key={c.id} className="flex items-center gap-3 rounded-xl border border-slate-100 p-3">
                  ...
                  {c.isDefault && <Badge variant="secondary" className="bg-blue-100 text-blue-700 border-blue-200 hover:bg-blue-100">Default</Badge>}
