    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-2xl space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Badge variant="secondary" className="bg-[#FFD54F]/10 text-[#0A1F44] border-[#FFD54F]/20 hover:bg-[#FFD54F]/10">{tracking.status}</Badge>
        </div>
        ...
        <Card className="bg-white rounded-xl overflow-hidden">
          <div className="h-56 bg-slate-100 flex items-center justify-center relative" role="img" aria-label="Live map showing provider location">
            ...
            <div className="absolute bottom-3 left-3 rounded-lg bg-white/90 px-3 py-1.5 backdrop-blur-sm">
              <div className="flex items-center gap-1.5 text-xs font-medium text-[#0A1F44]">
          ...
          <CardContent className="p-5 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Clock className="size-4 text-[#FFD54F]/800" />
                <span className="text-sm font-medium text-slate-900">Estimated Arrival</span>
              </div>
              <span className="text-lg font-bold text-[#0A1F44]">{tracking.eta}</span>
            </div>
        ...
        <Card className="bg-white rounded-xl">
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              <Avatar><AvatarFallback className="bg-[#0A1F44] text-white text-sm">{tracking.provider.initials}</AvatarFallback></Avatar>
              ...
              <Button variant="outline" size="sm" className="gap-1 border-[#FFD54F]/20 text-[#0A1F44] hover:bg-[#FFD54F]/10 rounded-lg" onClick={() => navigate('client-chat')} aria-label="Chat with provider"><MessageSquare className="size-3.5" /> Chat</Button>
            </div>
          </CardContent>
        </Card>
      </div>
