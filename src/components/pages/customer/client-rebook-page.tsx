    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-2xl space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-2" role="group" aria-label="Select preferred time">
                    {['9:00 AM', '10:00 AM', '11:00 AM', '2:00 PM', '3:00 PM', '4:00 PM'].map((t) => (
                      <Button key={t} variant={time === t ? 'default' : 'outline'} onClick={() => setTime(t)}
                        className={`rounded-lg text-xs ${time === t ? 'bg-blue-600 hover:bg-blue-700' : 'border-slate-200'}`}
        ...
        <div className="flex gap-3">
          ...
          <Button className="flex-1 bg-blue-600 hover:bg-blue-700 gap-1 rounded-xl" onClick={handleConfirm} disabled={submitting || !date || !time} aria-label="Confirm rebook">
