        ...
        <Card className="bg-white rounded-xl">
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              ...
              <Badge variant="secondary" className="bg-[#FFD54F]/10 text-[#0A1F44] border-[#FFD54F]/20 hover:bg-[#FFD54F]/10">In Progress</Badge>
            </div>
          </CardContent>
        </Card>
                ...
                <div key={i} className="flex gap-4">
                  <div className="flex flex-col items-center">
                    {step.status === 'completed' ? (
                      ...
                      <div className="flex size-7 items-center justify-center rounded-full bg-[#0A1F44]">
                  ...
                  <div className="pb-6 flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      {step.status === 'current' && <Badge variant="secondary" className="bg-[#FFD54F]/10 text-[#0A1F44] border-[#FFD54F]/20 hover:bg-[#FFD54F]/10 text-[10px]">Now</Badge>}
                    </div>
