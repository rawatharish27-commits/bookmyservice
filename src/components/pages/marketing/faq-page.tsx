...
const categories: { key: FAQCategory; icon: React.ElementType; color: string; bg: string }[] = [
  { key: 'General', icon: HelpCircle, color: 'text-blue-600', bg: 'bg-blue-50' },
...
const faqs: FAQ[] = [
  ...
  { question: 'Do you offer EMI options?', answer: 'Yes, we offer no-cost EMI on services above ₹3,000 through our banking partners. EMI options are available for 3, 6, and 12 months on select credit cards.', category: 'Payment' },

  // Services
  { question: 'What services do you offer?', answer: 'We offer 200+ services across categories including: Home Cleaning (deep cleaning, bathroom, kitchen), Repairs & Maintenance (plumbing, electrical, carpentry), Beauty & Wellness (salon at home, spa), Painting & Renovation, Appliance Repair, Pest Control, and more.', category: 'Services' },
  ...
  { question: 'What are AMC plans?', answer: 'Annual Maintenance Contracts (AMC) are yearly subscription plans that cover regular maintenance of your home appliances, plumbing, and electrical systems. Starting at ₹2,999/year, they include 4 scheduled visits and priority support.', category: 'Services' },
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          ...
          {categories.map((cat) => (
            <Button
              ...
              className={activeCategory === cat.key ? 'bg-blue-600 hover:bg-blue-700' : ''}
