      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="h-56 sm:h-72 rounded-xl bg-gradient-to-br from-[#0A1F44]/10 to-blue-200 flex items-center justify-center mb-6">
              <BookOpen className="size-16 text-blue-400" />
            </div>

            {/* Category & Meta */}
            <div className="flex flex-wrap items-center gap-3 mb-4">
              <Badge className="bg-[#FFD54F]/10 text-[#0A1F44]">Home Maintenance</Badge>
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-3">
                <Avatar className="size-11">
                  <AvatarFallback className="bg-[#0A1F44] text-white font-semibold">PS</AvatarFallback>
                </Avatar>
                <div>
            ...
            <article className="prose prose-slate max-w-none">
              ...
              <div className="bg-[#FFD54F]/10 rounded-xl p-5 mb-6">
                <ul className="space-y-2 text-sm text-slate-700">
                  <li className="flex items-start gap-2"><span className="text-[#0A1F44] font-bold">•</span> Check all faucets and pipes for leaks</li>
                  <li className="flex items-start gap-2"><span className="text-[#0A1F44] font-bold">•</span> Test smoke detectors and fire extinguishers</li>
                  <li className="flex items-start gap-2"><span className="text-[#0A1F44] font-bold">•</span> Clean AC filters and check for unusual sounds</li>
                  <li className="flex items-start gap-2"><span className="text-[#0A1F44] font-bold">•</span> Inspect electrical switches and wiring for damage</li>
                  <li className="flex items-start gap-2"><span className="text-[#0A1F44] font-bold">•</span> Clean kitchen and bathroom drains</li>
                  <li className="flex items-start gap-2"><span className="text-[#0A1F44] font-bold">•</span> Check water heater for leaks and efficiency</li>
                </ul>
              </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="shadow-sm border-0">
              <CardContent className="p-5 text-center">
                <Avatar className="size-16 mx-auto mb-3">
                  <AvatarFallback className="bg-[#0A1F44] text-white text-lg font-semibold">PS</AvatarFallback>
                </Avatar>
              ...
              <CardContent className="space-y-4">
                {relatedPosts.map((post) => (
                  <div key={post.title} className="flex gap-3 cursor-pointer group">
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-slate-900 line-clamp-2 group-hover:text-[#0A1F44] transition-colors leading-snug">
                        {post.title}
                      </h4>
            ...
            {/* Newsletter */}
            <Card className="shadow-sm border-0 bg-gradient-to-br from-[#0A1F44] to-[#0A1F44] text-white">
              <CardContent className="p-5">
                <h3 className="font-semibold mb-2">Weekly Newsletter</h3>
                <p className="text-sm text-[#FFD54F]/80 mb-4">Get the latest tips & updates delivered to your inbox.</p>
