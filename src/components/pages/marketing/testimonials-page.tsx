...
const serviceCategories = ['All', 'Home Cleaning', 'Plumbing', 'Electrical', 'Beauty & Wellness', 'Painting', 'Appliance Repair', 'Carpentry', 'Pest Control']

const testimonials = [
  { id: 1, name: 'Ananya Krishnan', avatar: 'AK', color: 'bg-blue-600', city: 'Chennai', service: 'Home Cleaning', rating: 5, date: '15 Feb 2025', text: 'Absolutely fantastic experience! The cleaning team was professional, thorough, and efficient. My apartment has never looked this clean. The deep cleaning service was worth every rupee. Will definitely book again!', verified: true, helpful: 42 },
  { id: 2, name: 'Rohit Verma', avatar: 'RV', color: 'bg-emerald-600', city: 'Delhi', service: 'Electrical', rating: 5, date: '12 Feb 2025', text: 'The electrician was punctual, skilled, and very polite. Fixed all the wiring issues in my house within 2 hours. Fair pricing with no hidden charges. The 30-day warranty gives me peace of mind.', verified: true, helpful: 38 },
  { id: 3, name: 'Sunita Joshi', avatar: 'SJ', color: 'bg-purple-600', city: 'Pune', service: 'Beauty & Wellness', rating: 5, date: '10 Feb 2025', text: 'Salon at home is a game changer! The beautician was well-trained and used high-quality products. Got ready for my friend\'s wedding without stepping out. The convenience is unmatched.', verified: true, helpful: 56 },
  { id: 4, name: 'Mohammed Faisal', avatar: 'MF', color: 'bg-orange-600', city: 'Hyderabad', service: 'Plumbing', rating: 4, date: '8 Feb 2025', text: 'Good service overall. The plumber arrived on time and fixed the leaking tap quickly. Only giving 4 stars because the booking process could be smoother. But the actual service was great.', verified: true, helpful: 24 },
  { id: 5, name: 'Kavitha Nair', avatar: 'KN', color: 'bg-teal-600', city: 'Bengaluru', service: 'Appliance Repair', rating: 5, date: '5 Feb 2025', text: 'My washing machine broke down and I was dreading the repair cost. BookMyService sent a technician within an hour who fixed it at a very reasonable price. Transparent pricing and no upselling!', verified: true, helpful: 31 },
  { id: 6, name: 'Arun Sharma', avatar: 'AS', color: 'bg-rose-600', city: 'Mumbai', service: 'Painting', rating: 5, date: '2 Feb 2025', text: 'Got my entire 2BHK painted through BookMyService. The team was professional, completed the work in 3 days as promised, and cleaned up after themselves. The quality of paint and workmanship is excellent.', verified: true, helpful: 47 },
  { id: 7, name: 'Deepa Reddy', avatar: 'DR', color: 'bg-amber-600', city: 'Hyderabad', service: 'Home Cleaning', rating: 4, date: '28 Jan 2025', text: 'Booked bathroom deep cleaning. The service was good but took longer than expected. However, the result was impressive — my bathroom looks brand new! Would recommend, just allow extra time.', verified: true, helpful: 19 },
  { id: 8, name: 'Vikram Singh', avatar: 'VS', color: 'bg-indigo-600', city: 'Jaipur', service: 'Carpentry', rating: 5, date: '25 Jan 2025', text: 'Needed custom wardrobe shelves. The carpenter understood my requirements perfectly and delivered exactly what I wanted. Clean work, professional approach, and fair pricing. Highly recommended!', verified: true, helpful: 35 },
  { id: 9, name: 'Meera Patel', avatar: 'MP', color: 'bg-cyan-600', city: 'Ahmedabad', service: 'Pest Control', rating: 5, date: '22 Jan 2025', text: 'Had a terrible cockroach problem. The pest control team did a thorough job and explained the treatment process. It\'s been 3 weeks and no sign of any pests. The follow-up visit was also helpful.', verified: true, helpful: 28 },
  { id: 10, name: 'Rajesh Kumar', avatar: 'RK', color: 'bg-lime-600', city: 'Lucknow', service: 'Electrical', rating: 4, date: '18 Jan 2025', text: 'Good electrical repair service. The technician was knowledgeable and fixed the issue. I appreciate the upfront pricing. Would have given 5 stars if the appointment had started on time.', verified: true, helpful: 15 },
  { id: 11, name: 'Pooja Gupta', avatar: 'PG', color: 'bg-pink-600', city: 'Delhi', service: 'Beauty & Wellness', rating: 5, date: '15 Jan 2025', text: 'The facial at home service was amazing! The beautician was gentle, used organic products, and gave me great skincare tips. My skin feels wonderful. Already booked my next session!', verified: true, helpful: 44 },
...
const videoTestimonials = [
  { name: 'Priya from Bengaluru', service: 'Deep Cleaning', duration: '2:30' },
  { name: 'Amit from Delhi', service: 'AC Repair', duration: '1:45' },
  { name: 'Lakshmi from Hyderabad', service: 'Salon at Home', duration: '3:15' },
]
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className="flex items-center gap-1.5">
                          ...
                          {testimonial.verified && <CheckCircle2 className="size-3 text-blue-500" />}
                        </div>
