    ...
    <div className="bg-[#f8fafc] min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#0A1F44] via-[#0A1F44] to-[#0A2E6B] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          <Badge className="bg-[#FFD54F]/100/30 text-[#FFD54F]/80 border-blue-400/30 mb-4">Press & Media</Badge>
          ...
          {[
            ...
            <Card key={stat.label} className="shadow-md border-0 text-center">
              <CardContent className="py-5">
                <stat.icon className="size-5 text-[#0A1F44] mx-auto mb-2" />
                ...
                <div className="flex items-center justify-between p-4 sm:p-5 hover:bg-slate-50 transition-colors cursor-pointer">
                  <div className="flex-1 min-w-0 mr-4">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-xs font-semibold text-[#0A1F44]">{article.source}</span>
            ...
            <Card key={item.title} className="shadow-sm border-0 hover:shadow-md transition-shadow">
              <CardContent className="p-5">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-[#FFD54F]/10 flex items-center justify-center shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Button variant="ghost" size="sm" className="text-[#0A1F44] gap-1 h-auto p-0 text-xs">
