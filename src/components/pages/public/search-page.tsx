...
import { Search, Star, Clock, X, TrendingUp, History, Sparkles } from 'lucide-react'

const suggestions = ['AC repair', 'Plumbing', 'Deep cleaning', 'Electrical wiring', 'Painting', 'CCTV installation']
const recentSearches = ['AC service near me', 'Plumber for leak', 'Home deep cleaning', 'Electrician']
const popularServices = [
  { name: 'AC Service & Repair', provider: 'CoolAir Solutions', rating: 4.8, price: 599, image: '❄️' },
  { name: 'Deep Home Cleaning', provider: 'SparkleClean Pro', rating: 4.9, price: 1299, image: '🏠' },
  { name: 'Plumbing Fix', provider: 'AquaFix Experts', rating: 4.6, price: 399, image: '🔧' },
  { name: 'Electrical Wiring', provider: 'PowerTech Electric', rating: 4.7, price: 449, image: '⚡' },
  { name: 'Interior Painting', provider: 'ColorCraft Studio', rating: 4.5, price: 2499, image: '🎨' },
  { name: 'CCTV Installation', provider: 'SecureView Tech', rating: 4.8, price: 1899, image: '📷' },
  { name: 'RO Water Purifier', provider: 'PureFlow Services', rating: 4.4, price: 349, image: '💧' },
  { name: 'Car Detailing', provider: 'AutoShine Pro', rating: 4.7, price: 999, image: '🚗' },
]
const trendingSearches = ['Summer AC service', 'Monsoon plumbing', 'Festive cleaning', 'Office disinfection']
    ...
    <div className="bg-[#f8fafc] min-h-screen">
      ...
      <section className="bg-gradient-to-br from-blue-600 to-purple-600 text-white py-10">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-200 mb-6">Search from 500+ professional home services</p>
          <div className="relative">
            ...
            />
            {query && (
              <button onClick={() => { setQuery(''); setShowSuggestions(false) }} className="absolute right-4 top-1/2 -translate-y-1/2">
