...
const offersData = [
  { title: 'AC Summer Bonanza', desc: 'Get 20% off on all AC services', code: 'SUMMER20', discount: '20% OFF', gradient: 'from-blue-500 to-cyan-400', validTill: '2025-03-31', category: 'Air Conditioner' },
  ...
  { title: 'Water Purifier Deal', desc: '10% off on RO service and filter change', code: 'RO10', discount: '10% OFF', gradient: 'from-teal-500 to-cyan-400', validTill: '2025-04-05', category: 'Water Purifier' },
]
