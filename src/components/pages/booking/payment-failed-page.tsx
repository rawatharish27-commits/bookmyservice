        ...
        <Card className="bg-white rounded-xl text-center">
          <CardContent className="p-8 space-y-4">
            ...
            <div className="space-y-2 pt-2">
              <Button className="w-full bg-[#0A1F44] hover:bg-[#0A1F44]/90 text-white gap-1 rounded-xl" onClick={() => navigate('booking-payment')}><RefreshCw className="size-4" /> Retry Payment</Button>
