        ...
        <CardContent className="p-8 text-center space-y-4">
          {status === 'processing' ? (
            <>
              ...
              <p className="text-sm text-slate-500">Please wait while we process your payment of ₹1,039</p>
              ...
              <div className="mt-4 space-y-2">
                <div className="flex items-center justify-between rounded-lg bg-slate-50 p-3 text-sm">
                  <div className="flex items-center gap-2"><CreditCard className="size-4 text-slate-400" /><span className="text-slate-600">Card •••• 4242</span></div>
                  <span className="font-semibold text-slate-900">₹1,039</span>
                </div>
              </div>
            </>
          ) : (
