        ...
        <Card className="bg-white rounded-xl text-center">
          <CardContent className="p-8 space-y-4">
            ...
            <div className="space-y-2 pt-2">
              <Button className="w-full bg-blue-600 hover:bg-blue-700 gap-1 rounded-xl" onClick={() => navigate('booking-confirmation')}><MapPin className="size-4" /> Track Booking</Button>
