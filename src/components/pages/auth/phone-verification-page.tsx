      ...
      <Card className="w-full max-w-md bg-white rounded-xl shadow-sm border-slate-100">
        <CardContent className="p-8">
          ...
          <p className="text-center text-xs text-slate-400">
            By verifying, you agree to our <button className="text-[#0A1F44] hover:underline">Terms</button> and <button className="text-[#0A1F44] hover:underline">Privacy Policy</button>
          </p>
        </CardContent>
      </Card>
    </div>
