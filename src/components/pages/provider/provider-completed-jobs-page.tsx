    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Card className="bg-white rounded-xl"><CardContent className="p-4 text-center"><p className="text-2xl font-bold text-blue-600">{completedJobs.length}</p><p className="text-xs text-slate-500">Jobs Completed</p></CardContent></Card>
        </div>
