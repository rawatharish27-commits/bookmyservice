  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <Card className="bg-white rounded-xl">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-2"><Clock className="size-4 text-[#0A1F44]" /><CardTitle className="text-sm font-semibold text-slate-900">Duration</CardTitle></div>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="flex gap-3">
          <Button className="flex-1 bg-[#0A1F44] hover:bg-[#0A1F44]/90 text-white gap-1 rounded-xl"><Save className="size-4" /> Update Service</Button>
