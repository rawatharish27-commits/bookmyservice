...
const statusConfig: Record<string, { color: string; icon: React.ComponentType<{ className?: string }> }> = {
  ...
  'Under Review': { color: 'bg-blue-100 text-blue-700 border-blue-200', icon: Clock },
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {doc.fileName ? (
                      ...
                      <div className="mt-2">
                        <Button size="sm" className="h-7 text-xs gap-1 bg-blue-600 hover:bg-blue-700 rounded-lg"><Upload className="size-3" /> Upload Document</Button>
                      </div>
                    )}
                  </div>
                </div>
