      ...
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <Card className="bg-white rounded-xl overflow-hidden">
          <div className="bg-gradient-to-r from-[#0A1F44] to-[#0A1F44] p-5 text-white">
            <p className="text-sm font-medium text-[#FFD54F]/80">Next Payout</p>
            <p className="text-3xl font-bold mt-1">₹7,650</p>
            <p className="text-xs text-blue-200 mt-1">Scheduled for 27 May 2024</p>
          </div>
          <CardContent className="p-4">
            <div className="flex gap-3">
              <Button className="flex-1 bg-[#0A1F44] hover:bg-[#0A1F44]/90 text-white gap-1 rounded-xl"><ArrowUpRight className="size-4" /> Withdraw Now</Button>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white rounded-xl">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-2"><Building2 className="size-4 text-[#0A1F44]" /><CardTitle className="text-sm font-semibold text-slate-900">Bank Details</CardTitle></div>
          </CardHeader>
          <CardContent>
