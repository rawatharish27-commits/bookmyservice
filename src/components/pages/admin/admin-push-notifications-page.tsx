...
const statusColors: Record<string, string> = {
  ...
  Scheduled: 'bg-[#FFD54F]/10 text-[#0A1F44] border-[#FFD54F]/20',
    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-4xl space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button size="sm" className="gap-1 bg-[#0A1F44] hover:bg-[#0A1F44]/90 text-white rounded-xl"><BellRing className="size-4" /> New Campaign</Button>
        </div>
        ...
        <Card className="bg-white rounded-xl">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <Button size="sm" className="bg-[#0A1F44] hover:bg-[#0A1F44]/90 text-white gap-1 text-xs rounded-xl"><Send className="size-3" /> Send Now</Button>
            ...
            {campaigns.map((c, i) => (
              <div key={c.id}>
                <div className="flex items-center gap-4 py-3">
                  <div className="flex size-9 items-center justify-center rounded-lg bg-[#FFD54F]/10"><BellRing className="size-4 text-[#0A1F44]" /></div>
