    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button size="sm" className="gap-1 bg-[#0A1F44] hover:bg-[#0A1F44]/90 text-white rounded-xl"><Plus className="size-4" /> Create Coupon</Button>
        </div>
                ...
                <tbody>
                  {coupons.map((c) => (
                    <tr key={c.id} className="border-b border-slate-50 hover:bg-slate-50/50">
                      <td className="px-4 py-3"><div className="flex items-center gap-2"><Tag className="size-4 text-[#0A1F44]" /><span className="text-sm font-mono font-semibold text-slate-700">{c.code}</span></div></td>
