    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button size="sm" className="gap-1 bg-blue-600 hover:bg-blue-700 rounded-xl"><Send className="size-4" /> Broadcast</Button>
        </div>
        ...
        <Card className="bg-white rounded-xl">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-xs gap-1 rounded-lg"><Send className="size-3" /> Send to All</Button>
            </div>
          </CardContent>
        </Card>
            ...
            {templates.map((t, i) => (
              <div key={t.id}>
                <div className="flex items-center gap-4 py-3">
                  <div className="flex size-9 items-center justify-center rounded-lg bg-blue-50"><Bell className="size-4 text-blue-600" /></div>
