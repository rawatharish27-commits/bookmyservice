    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="bg-white rounded-xl"><CardContent className="p-4 text-center"><p className="text-lg font-bold text-[#0A1F44]">{walletOverview.totalBalance}</p><p className="text-xs text-slate-500">Total Balance</p></CardContent></Card>
            ...
            {userWallets.map((w, i) => (
              <div key={w.id}>
                <div className="flex items-center gap-4 py-3">
                  <div className="flex size-10 items-center justify-center rounded-full bg-[#FFD54F]/10 text-sm font-bold text-[#0A1F44]">{w.name.charAt(0)}</div>
