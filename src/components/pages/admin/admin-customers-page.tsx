      ...
      <div className="mx-auto max-w-5xl space-y-6">
                    ...
                    <tr key={c.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          <div className="flex size-8 items-center justify-center rounded-full bg-[#FFD54F]/10 text-xs font-bold text-[#0A1F44]">{c.name.charAt(0)}</div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-1">
            ...
            <Button variant="outline" size="sm" className="h-8 w-8 p-0 bg-[#0A1F44] text-white border-[#0A1F44]">1</Button>
