      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <Card className="bg-white rounded-xl">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-2"><Search className="size-4 text-[#0A1F44]" /><CardTitle className="text-sm font-semibold text-slate-900">Meta Tags</CardTitle></div>
          </CardHeader>
        ...
        <Card className="bg-white rounded-xl">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-2"><Globe className="size-4 text-[#0A1F44]" /><CardTitle className="text-sm font-semibold text-slate-900">Sitemap</CardTitle></div>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="flex items-center justify-between"><div><p className="text-sm text-slate-700">Sitemap URL</p><p className="text-xs text-[#0A1F44]">https://bookmyservice.com/sitemap.xml</p></div><Button variant="outline" size="sm" className="text-xs rounded-lg">Regenerate</Button></div>
        ...
        <Card className="bg-white rounded-xl">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-2"><Code className="size-4 text-[#0A1F44]" /><CardTitle className="text-sm font-semibold text-slate-900">robots.txt</CardTitle></div>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white rounded-xl">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-2"><BarChart3 className="size-4 text-[#0A1F44]" /><CardTitle className="text-sm font-semibold text-slate-900">Analytics Code</CardTitle></div>
          </CardHeader>
          <CardContent className="space-y-3">
