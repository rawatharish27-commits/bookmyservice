    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-6">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <Card className="bg-white rounded-xl"><CardContent className="p-4 text-center"><MessageSquare className="size-5 text-[#0A1F44] mx-auto mb-1" /><p className="text-lg font-bold text-[#0A1F44]">{activeConversations.length}</p><p className="text-xs text-slate-500">Active Chats</p></CardContent></Card>
