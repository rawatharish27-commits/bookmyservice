        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <main className="flex-1 min-w-0 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="rounded-lg border border-slate-200 p-4">
                    ...
                    <ul className="space-y-1.5 text-sm text-slate-600">
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Full name, email address, and phone number</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Residential and billing addresses</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Date of birth and gender (optional)</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Government-issued ID (for KYC verification of service providers)</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Profile photographs (optional)</li>
                    </ul>
                  </div>
                  ...
                  <div className="rounded-lg border border-slate-200 p-4">
                    ...
                    <ul className="space-y-1.5 text-sm text-slate-600">
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Payment method details (credit/debit card, UPI, wallets)</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Billing history and transaction records</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Bank account details (for service provider payouts)</li>
                    </ul>
                  ...
                  <div className="rounded-lg border border-slate-200 p-4">
                    ...
                    <ul className="space-y-1.5 text-sm text-slate-600">
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Device type, operating system, and browser information</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> IP address and approximate location (city-level)</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Pages visited, features used, and time spent on the platform</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Search queries and service preferences</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Push notification and communication preferences</li>
                    </ul>
                  </div>
                  ...
                  <div className="rounded-lg border border-slate-200 p-4">
                    ...
                    <ul className="space-y-1.5 text-sm text-slate-600">
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Google/Facebook account data (when using social login)</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Referral information from existing users</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Background check results (for service providers)</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex gap-3">
                    <div className="flex items-center justify-center size-8 rounded-full bg-blue-50 text-blue-600 shrink-0 text-sm font-bold">1</div>
                    <div>
                  ...
                  <Separator />
                  <div className="flex gap-3">
                    <div className="flex items-center justify-center size-8 rounded-full bg-blue-50 text-blue-600 shrink-0 text-sm font-bold">2</div>
                    <div>
                  ...
                  <Separator />
                  <div className="flex gap-3">
                    <div className="flex items-center justify-center size-8 rounded-full bg-blue-50 text-blue-600 shrink-0 text-sm font-bold">3</div>
                    <div>
                  ...
                  <Separator />
                  <div className="flex gap-3">
                    <div className="flex items-center justify-center size-8 rounded-full bg-blue-50 text-blue-600 shrink-0 text-sm font-bold">4</div>
                    <div>
                  ...
                  <Separator />
                  <div className="flex gap-3">
                    <div className="flex items-center justify-center size-8 rounded-full bg-blue-50 text-blue-600 shrink-0 text-sm font-bold">5</div>
                    <div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    ...
                    <tbody className="text-slate-600">
                      ...
                      <tr className="border-b border-slate-100">
                        <td className="py-2 px-3"><Badge variant="outline" className="text-xs bg-blue-50 text-blue-700 border-blue-200">Functional</Badge></td>
            ...
            <Card id="children-privacy" className="bg-white rounded-xl">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg font-bold text-slate-900">
                  <Baby className="size-5 text-blue-600" />
            ...
            <Card id="changes" className="bg-white rounded-xl">
              ...
              <CardContent className="space-y-4">
                ...
                <ul className="space-y-2 text-sm text-slate-600">
                  <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> We will notify you via email and in-app notification at least 15 days before the changes take effect</li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> The &quot;Last Updated&quot; date at the top of this page will be revised</li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> Continued use of our platform after changes constitutes acceptance of the revised policy</li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-blue-600 mt-0.5 shrink-0" /> For significant changes, we may require your explicit consent</li>
                </ul>
              </CardContent>
            </Card>
