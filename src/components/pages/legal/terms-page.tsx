          ...
          <main className="flex-1 min-w-0 space-y-6">
            ...
            <Card id="acceptance" className="bg-white rounded-xl">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="rounded-lg bg-[#FFD54F]/10 border border-[#FFD54F]/20 p-4">
                  ...
                  <ul className="space-y-1.5 text-xs text-[#0A1F44]">
                    <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-[#FFD54F]/800 mt-0.5 shrink-0" /> You have read and understood these Terms in their entirety</li>
                    <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-[#FFD54F]/800 mt-0.5 shrink-0" /> You are at least 18 years of age</li>
                    <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-[#FFD54F]/800 mt-0.5 shrink-0" /> You have the legal capacity to enter into a binding agreement</li>
                    <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-[#FFD54F]/800 mt-0.5 shrink-0" /> You agree to comply with all applicable laws and regulations</li>
                  </ul>
                </div>
                <p className="text-sm text-slate-600 leading-relaxed">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="rounded-lg border border-slate-200 p-4">
                    ...
                    <ul className="space-y-2 text-xs text-slate-600">
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-3 text-[#FFD54F]/800 mt-0.5 shrink-0" /> All Customer requirements</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-3 text-[#FFD54F]/800 mt-0.5 shrink-0" /> Aadhaar / PAN verification</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-3 text-[#FFD54F]/800 mt-0.5 shrink-0" /> Professional certifications (if applicable)</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-3 text-[#FFD54F]/800 mt-0.5 shrink-0" /> Bank account for payouts</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-3 text-[#FFD54F]/800 mt-0.5 shrink-0" /> Background verification clearance</li>
                    </ul>
                  </div>
                </div>
            ...
            <Card id="service-booking" className="bg-white rounded-xl">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg font-bold text-slate-900">
                  <CalendarCheck className="size-5 text-[#0A1F44]" />
                  3. Service Booking
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 sm:items-center">
                      {['Select Service', 'Choose Provider', 'Pick Date/Time', 'Confirm & Pay', 'Service Delivered'].map((step, i) => (
                        <div key={step} className="flex items-center gap-2">
                          <div className="flex items-center justify-center size-6 rounded-full bg-[#0A1F44] text-white text-xs font-bold">{i + 1}</div>
                  ...
                  <div className="rounded-lg border border-slate-200 p-4">
                    ...
                    <ul className="space-y-1.5 text-sm text-slate-600">
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-[#0A1F44] mt-0.5 shrink-0" /> Service prices are inclusive of all applicable taxes (GST)</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-[#0A1F44] mt-0.5 shrink-0" /> Estimated service duration may vary based on actual work required</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-[#0A1F44] mt-0.5 shrink-0" /> Additional charges may apply for extra work not included in the original booking</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-[#0A1F44] mt-0.5 shrink-0" /> You must ensure access to the service location at the scheduled time</li>
                      <li className="flex items-start gap-2"><CheckCircle2 className="size-4 text-[#0A1F44] mt-0.5 shrink-0" /> Service providers carry valid ID that must be verified before granting access</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
            ...
            <Card id="payment-terms" className="bg-white rounded-xl">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg font-bold text-slate-900">
                  <CreditCard className="size-5 text-[#0A1F44]" />
                  4. Payment Terms
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="rounded-lg border border-slate-200 p-4">
                  ...
                  <ul className="space-y-1.5 text-xs text-slate-600">
                    <li className="flex items-start gap-2"><IndianRupee className="size-3 text-[#0A1F44] mt-0.5 shrink-0" /> All prices include 18% GST unless otherwise stated</li>
                    <li className="flex items-start gap-2"><IndianRupee className="size-3 text-[#0A1F44] mt-0.5 shrink-0" /> Payment is authorized at booking and captured upon service completion</li>
                    <li className="flex items-start gap-2"><IndianRupee className="size-3 text-[#0A1F44] mt-0.5 shrink-0" /> Platform commission of 15-20% is deducted from provider payout</li>
                    <li className="flex items-start gap-2"><IndianRupee className="size-3 text-[#0A1F44] mt-0.5 shrink-0" /> Invoices are auto-generated and available in your account</li>
                    <li className="flex items-start gap-2"><IndianRupee className="size-3 text-[#0A1F44] mt-0.5 shrink-0" /> Cash payments are not accepted for safety and transparency</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
            ...
            <Card id="cancellation-refund" className="bg-white rounded-xl">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg font-bold text-slate-900">
                  <RotateCcw className="size-5 text-[#0A1F44]" />
            ...
            <Card id="provider-terms" className="bg-white rounded-xl">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg font-bold text-slate-900">
                  <Wrench className="size-5 text-[#0A1F44]" />
            ...
            <Card id="intellectual-property" className="bg-white rounded-xl">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg font-bold text-slate-900">
                  <Copyright className="size-5 text-[#0A1F44]" />
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item.step} className="flex gap-3">
                      <div className="flex items-center justify-center size-8 rounded-full bg-[#0A1F44] text-white text-sm font-bold shrink-0">{item.step}</div>
                      <div>
            ...
            <Card id="governing-law" className="bg-white rounded-xl">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg font-bold text-slate-900">
                  <Landmark className="size-5 text-[#0A1F44]" />
