...
async function main() {
  ...
  const bookingDataList = [
    ...
    { clientId: clients[0].id, providerId: providers[3].id, serviceId: services[9].id, scheduledDate: '2025-07-18', scheduledTime: '14:00', serviceAddress: '23, Banjara Hills, Hyderabad', basePrice: 349, finalPrice: 349, status: 'COMPLETED', paymentStatus: 'PAID', completedAt: new Date('2025-07-18T15:00:00') },
    { clientId: clients[5].id, providerId: providers[4].id, serviceId: services[12].id, scheduledDate: '2025-07-20', scheduledTime: '10:00', serviceAddress: '12, Madhapur, Hyderabad', basePrice: 399, finalPrice: 399, status: 'COMPLETED', paymentStatus: 'PAID', completedAt: new Date('2025-07-20T11:00:00') },
    ...
    { clientId: clients[3].id, providerId: providers[2].id, serviceId: services[7].id, scheduledDate: '2025-08-01', scheduledTime: '15:00', serviceAddress: '34, Whitefield, Bengaluru', basePrice: 499, finalPrice: 499, status: 'COMPLETED', paymentStatus: 'PAID', completedAt: new Date('2025-08-01T16:30:00') },
    { clientId: clients[1].id, providerId: providers[1].id, serviceId: services[5].id, scheduledDate: '2025-08-05', scheduledTime: '09:00', serviceAddress: '56, GK-II, New Delhi', basePrice: 349, finalPrice: 349, status: 'COMPLETED', paymentStatus: 'PAID', completedAt: new Date('2025-08-05T10:30:00') },
