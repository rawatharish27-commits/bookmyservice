...
2.3 Service Providers must possess the necessary qualifications, licenses, and permits required by applicable Indian law to perform the services they list on the Platform (e.g., electrical license from the State Electricity Board, relevant service certification).
...
20.2 Service Providers must obtain and maintain all necessary permits, licenses, and registrations required for their trade in the jurisdiction where they operate.
...
2.8 Service Data: Service categories browsed, subcategories selected, booking details, service addresses, and special instructions.
...
2.2 They help us remember your preferences, understand how you use our Platform, and improve your experience when browsing for our listed home services.
...
• Saving your search preferences and category filters
...
2.3 Service Providers may list and offer services only within our approved service categories: Air Conditioner, Refrigerator, Washing Machine, Kitchen Appliances, TV Repair, Water Purifier, Geyser, Plumber, Electrician, Water Tank Cleaning, and Movers and Packers.
...
4.1 AIR CONDITIONER SERVICES: Providers offering AC services must hold relevant certifications or licenses as required by applicable state regulations. Services include but are not limited to: AC installation, AC repair and troubleshooting, AC gas refilling, AC cleaning and servicing, ducted AC service, and central AC maintenance.
4.2 REFRIGERATOR SERVICES: Providers offering refrigerator services must possess appropriate technical qualifications. Services include but are not limited to: fridge repair, compressor repair, gas refilling, thermostat replacement, fridge servicing, and fridge installation.
4.3 WASHING MACHINE SERVICES: Providers offering washing machine services must have relevant repair experience. Services include but are not limited to: drum repair, motor repair, drainage fixing, washing machine servicing, installation, and dryer repair.
4.4 KITCHEN APPLIANCES SERVICES: Providers offering kitchen appliance services must be qualified to repair household appliances. Services include but are not limited to: microwave repair, chimney repair and cleaning, dishwasher repair, cooktop repair, and mixer grinder repair.
4.5 TV REPAIR SERVICES: Providers offering TV repair services must hold relevant electronics repair qualifications. Services include but are not limited to: LED/LCD TV repair, smart TV setup, TV wall mounting, panel repair, and board repair.
4.6 WATER PURIFIER SERVICES: Providers offering water purifier services must be trained in RO/UV/UF systems. Services include but are not limited to: RO installation, RO repair, filter replacement, membrane replacement, and annual maintenance.
4.7 GEYSER SERVICES: Providers offering geyser services must be qualified in water heater repair. Services include but are not limited to: geyser installation, heating element repair, thermostat repair, geyser servicing, and solar water heater repair.
4.8 PLUMBER SERVICES: Providers offering plumbing services must hold valid plumbing certifications or licenses as required by applicable state regulations. Services include but are not limited to: leak repair, pipe installation, drain cleaning, faucet replacement, and toilet repair.
4.9 ELECTRICIAN SERVICES: Providers offering electrical services must hold valid electrical licenses from the State Electricity Board or equivalent authority. Services include but are not limited to: wiring and rewiring, light fixture installation, ceiling fan installation, socket and switch repair, and MCB and DB box installation.
4.10 WATER TANK CLEANING SERVICES: Providers offering water tank cleaning services must follow proper sanitization protocols. Services include but are not limited to: domestic tank cleaning, commercial tank cleaning, tank disinfection, and sump cleaning.
4.11 MOVERS AND PACKERS SERVICES: Providers offering moving and packing services must be registered and insured. Services include but are not limited to: house shifting, office relocation, vehicle transport, storage and warehousing, and professional packing.
...
4.1 The Provider may ONLY list services within our approved service categories: Air Conditioner, Refrigerator, Washing Machine, Kitchen Appliances, TV Repair, Water Purifier, Geyser, Plumber, Electrician, Water Tank Cleaning, and Movers and Packers.
...
3.6 SAFETY COMPLIANCE: Follow all safety protocols relevant to your trade. Use appropriate safety equipment. Ensure all service work meets applicable safety codes.
...
• Support Hours: 8:00 AM - 10:00 PM IST, 7 days a week`,
  ...
  // ========================================
  // 7. REVENUE STREAMS (for 11 categories)
  // ========================================
  console.log('💰 Creating revenue streams...');
  const revenueStreamData = [
    // Air Conditioner category revenue
    { streamType: 'Air Conditioner Booking Commission', description: 'Percentage commission on completed AC service bookings (installation, repair, servicing, gas refilling, etc.)', revenueModel: 'COMMISSION', estimatedMonthlyRevenue: 250000, status: 'ACTIVE' },
    ...
    { streamType: 'Air Conditioner Premium Provider Plan', description: 'Monthly subscription for premium AC service providers with priority listing and lower commission', revenueModel: 'SUBSCRIPTION', estimatedMonthlyRevenue: 100000, status: 'ACTIVE' },

    // Refrigerator category revenue
    { streamType: 'Refrigerator Booking Commission', description: 'Percentage commission on completed refrigerator service bookings (repair, servicing, gas refilling, etc.)', revenueModel: 'COMMISSION', estimatedMonthlyRevenue: 150000, status: 'ACTIVE' },
    { streamType: 'Refrigerator Featured Listing', description: 'Featured placement for providers within the Refrigerator category page', revenueModel: 'FEATURED_LISTING', estimatedMonthlyRevenue: 30000, status: 'ACTIVE' },
    { streamType: 'Refrigerator Premium Provider Plan', description: 'Monthly subscription for premium refrigerator service providers with priority listing and lower commission', revenueModel: 'SUBSCRIPTION', estimatedMonthlyRevenue: 70000, status: 'ACTIVE' },

    // Washing Machine category revenue
    { streamType: 'Washing Machine Booking Commission', description: 'Percentage commission on completed washing machine service bookings (repair, servicing, installation, etc.)', revenueModel: 'COMMISSION', estimatedMonthlyRevenue: 140000, status: 'ACTIVE' },
    { streamType: 'Washing Machine Featured Listing', description: 'Featured placement for providers within the Washing Machine category page', revenueModel: 'FEATURED_LISTING', estimatedMonthlyRevenue: 28000, status: 'ACTIVE' },
    { streamType: 'Washing Machine Premium Provider Plan', description: 'Monthly subscription for premium washing machine service providers with priority listing and lower commission', revenueModel: 'SUBSCRIPTION', estimatedMonthlyRevenue: 65000, status: 'ACTIVE' },

    // Kitchen Appliances category revenue
    { streamType: 'Kitchen Appliances Booking Commission', description: 'Percentage commission on completed kitchen appliance service bookings (microwave, chimney, dishwasher repair, etc.)', revenueModel: 'COMMISSION', estimatedMonthlyRevenue: 120000, status: 'ACTIVE' },
    { streamType: 'Kitchen Appliances Featured Listing', description: 'Featured placement for providers within the Kitchen Appliances category page', revenueModel: 'FEATURED_LISTING', estimatedMonthlyRevenue: 25000, status: 'ACTIVE' },
    { streamType: 'Kitchen Appliances Premium Provider Plan', description: 'Monthly subscription for premium kitchen appliance service providers with priority listing and lower commission', revenueModel: 'SUBSCRIPTION', estimatedMonthlyRevenue: 55000, status: 'ACTIVE' },

    // TV Repair category revenue
    { streamType: 'TV Repair Booking Commission', description: 'Percentage commission on completed TV repair service bookings (LED/LCD repair, smart TV setup, wall mount, etc.)', revenueModel: 'COMMISSION', estimatedMonthlyRevenue: 130000, status: 'ACTIVE' },
    { streamType: 'TV Repair Featured Listing', description: 'Featured placement for providers within the TV Repair category page', revenueModel: 'FEATURED_LISTING', estimatedMonthlyRevenue: 26000, status: 'ACTIVE' },
    { streamType: 'TV Repair Premium Provider Plan', description: 'Monthly subscription for premium TV repair providers with priority listing and lower commission', revenueModel: 'SUBSCRIPTION', estimatedMonthlyRevenue: 60000, status: 'ACTIVE' },

    // Water Purifier category revenue
    { streamType: 'Water Purifier Booking Commission', description: 'Percentage commission on completed water purifier service bookings (RO installation, repair, filter replacement, etc.)', revenueModel: 'COMMISSION', estimatedMonthlyRevenue: 110000, status: 'ACTIVE' },
    { streamType: 'Water Purifier Featured Listing', description: 'Featured placement for providers within the Water Purifier category page', revenueModel: 'FEATURED_LISTING', estimatedMonthlyRevenue: 22000, status: 'ACTIVE' },
    { streamType: 'Water Purifier Premium Provider Plan', description: 'Monthly subscription for premium water purifier service providers with priority listing and lower commission', revenueModel: 'SUBSCRIPTION', estimatedMonthlyRevenue: 50000, status: 'ACTIVE' },

    // Geyser category revenue
    { streamType: 'Geyser Booking Commission', description: 'Percentage commission on completed geyser service bookings (installation, repair, servicing, etc.)', revenueModel: 'COMMISSION', estimatedMonthlyRevenue: 90000, status: 'ACTIVE' },
    { streamType: 'Geyser Featured Listing', description: 'Featured placement for providers within the Geyser category page', revenueModel: 'FEATURED_LISTING', estimatedMonthlyRevenue: 18000, status: 'ACTIVE' },
    { streamType: 'Geyser Premium Provider Plan', description: 'Monthly subscription for premium geyser service providers with priority listing and lower commission', revenueModel: 'SUBSCRIPTION', estimatedMonthlyRevenue: 40000, status: 'ACTIVE' },
    ...
    { streamType: 'Water Tank Cleaning Booking Commission', description: 'Percentage commission on completed water tank cleaning service bookings (domestic, commercial, disinfection, etc.)', revenueModel: 'COMMISSION', estimatedMonthlyRevenue: 80000, status: 'ACTIVE' },
    { streamType: 'Water Tank Cleaning Featured Listing', description: 'Featured placement for providers within the Water Tank Cleaning category page', revenueModel: 'FEATURED_LISTING', estimatedMonthlyRevenue: 15000, status: 'ACTIVE' },
    { streamType: 'Water Tank Cleaning Premium Provider Plan', description: 'Monthly subscription for premium water tank cleaning providers with priority listing and lower commission', revenueModel: 'SUBSCRIPTION', estimatedMonthlyRevenue: 35000, status: 'ACTIVE' },

    // Movers and Packers category revenue
    { streamType: 'Movers and Packers Booking Commission', description: 'Percentage commission on completed moving and packing service bookings (house shifting, office relocation, vehicle transport, etc.)', revenueModel: 'COMMISSION', estimatedMonthlyRevenue: 200000, status: 'ACTIVE' },
    { streamType: 'Movers and Packers Featured Listing', description: 'Featured placement for providers within the Movers and Packers category page', revenueModel: 'FEATURED_LISTING', estimatedMonthlyRevenue: 38000, status: 'ACTIVE' },
    { streamType: 'Movers and Packers Premium Provider Plan', description: 'Monthly subscription for premium movers and packers providers with priority listing and lower commission', revenueModel: 'SUBSCRIPTION', estimatedMonthlyRevenue: 85000, status: 'ACTIVE' },
  ...
  // ========================================
  // 8. SEO METADATA (for 11 categories)
  // ========================================
  console.log('🔍 Creating SEO metadata...');
  const seoData = [
    {
      pageType: 'home',
      title: 'BookYourService — Trusted Home Services in India | AC, Fridge, Washing Machine & More',
      description: 'Book verified professionals for Air Conditioner, Refrigerator, Washing Machine, Kitchen Appliances, TV Repair, Water Purifier, Geyser, Plumber, Electrician, Water Tank Cleaning, and Movers and Packers services at your doorstep. Trusted providers in Delhi, Mumbai, Bengaluru, Hyderabad & Chennai.',
      keywords: 'home services, AC repair, refrigerator repair, washing machine repair, TV repair, water purifier, geyser repair, plumber, electrician, water tank cleaning, movers and packers, India, Delhi, Mumbai, Bengaluru, Hyderabad, Chennai',
    ...
    },
    {
      ...
      title: 'Air Conditioner Services — AC Repair, Installation & Servicing | BookYourService',
      description: 'Expert AC services including installation, repair, gas refilling, deep cleaning, and regular servicing. Book verified AC technicians in Delhi, Mumbai, Bengaluru, Hyderabad & Chennai.',
      keywords: 'AC repair near me, AC installation, AC gas refilling, AC cleaning, AC servicing, air conditioner repair, split AC service, window AC repair, book AC technician online',
    ...
    },
    {
      pageType: 'category',
      pageId: 'refrigerator',
      title: 'Refrigerator Services — Fridge Repair & Servicing | BookYourService',
      description: 'Professional refrigerator services including cooling issue repair, compressor repair, gas refilling, thermostat replacement, and regular servicing. Book verified fridge technicians in top Indian cities.',
      keywords: 'refrigerator repair near me, fridge repair, fridge gas refilling, compressor repair, fridge servicing, refrigerator installation, book fridge technician online',
    ...
    },
    {
      ...
      title: 'Washing Machine Services — Repair & Installation | BookYourService',
      description: 'Washing machine repair, servicing, and installation services including drum repair, motor fixing, drainage issues, and dryer repair. Book verified technicians in top Indian cities.',
      keywords: 'washing machine repair near me, washing machine servicing, washing machine installation, dryer repair, drum repair, motor repair, book washing machine technician online',
    ...
    },
    {
      ...
      title: 'Kitchen Appliances Services — Microwave, Chimney & Dishwasher Repair | BookYourService',
      description: 'Kitchen appliance repair services including microwave repair, chimney cleaning and repair, dishwasher repair, cooktop repair, and mixer grinder repair. Book verified technicians in top Indian cities.',
      keywords: 'kitchen appliance repair near me, microwave repair, chimney repair, dishwasher repair, cooktop repair, mixer grinder repair, book kitchen appliance technician online',
    ...
    },
    {
      pageType: 'category',
      pageId: 'tv-repair',
      title: 'TV Repair Services — LED, LCD & Smart TV Repair | BookYourService',
      description: 'TV repair services including LED/LCD panel repair, smart TV setup, TV wall mounting, and board repair. Book verified TV technicians in Delhi, Mumbai, Bengaluru, Hyderabad & Chennai.',
      keywords: 'TV repair near me, LED TV repair, LCD TV repair, smart TV setup, TV wall mount, TV panel repair, book TV technician online',
    ...
    },
    {
      ...
      title: 'Water Purifier Services — RO Installation, Repair & Filter Replacement | BookYourService',
      description: 'Water purifier services including RO installation, repair, filter replacement, membrane replacement, and annual maintenance. Book verified RO technicians in top Indian cities.',
      keywords: 'water purifier repair near me, RO installation, RO repair, filter replacement, water purifier servicing, RO membrane replacement, book RO technician online',
    ...
    },
    {
      pageType: 'category',
      pageId: 'geyser',
      title: 'Geyser Services — Water Heater Installation & Repair | BookYourService',
      description: 'Geyser and water heater services including installation, heating element repair, thermostat repair, servicing, and solar water heater repair. Book verified technicians in top Indian cities.',
      keywords: 'geyser repair near me, water heater installation, geyser servicing, heating element repair, thermostat repair, solar water heater, book geyser technician online',
    ...
    },
    {
      ...
      description: 'Expert plumbing services including leak repair, drain cleaning, pipe installation, faucet repair, toilet installation, and more. Book verified plumbers in Delhi, Mumbai, Bengaluru, Hyderabad & Chennai.',
      keywords: 'plumber near me, leak repair, drain cleaning, pipe installation, faucet repair, toilet repair, plumbing services India, book plumber online',
    ...
    },
    {
      ...
      description: 'Licensed electrical services including wiring repairs, light fixture installation, socket repairs, circuit breaker fixing, ceiling fan installation, and more. Book verified electricians in top Indian cities.',
      keywords: 'electrician near me, wiring repair, light fixture installation, socket repair, circuit breaker, ceiling fan, electrical services India, book electrician online',
    ...
    },
    {
      ...
      title: 'Water Tank Cleaning Services — Professional Tank Cleaning & Sanitization | BookYourService',
      description: 'Professional water tank cleaning and sanitization services including domestic tank cleaning, commercial tank cleaning, tank disinfection, and sump cleaning. Book verified cleaning professionals in top Indian cities.',
      keywords: 'water tank cleaning near me, tank cleaning service, tank sanitization, sump cleaning, water tank disinfection, book tank cleaning online',
    ...
    },
    {
      ...
      title: 'Movers and Packers — Reliable Packing & Moving Services | BookYourService',
      description: 'Reliable packing, moving, and relocation services including house shifting, office relocation, vehicle transport, storage solutions, and professional packing. Book verified movers in top Indian cities.',
    ...
    },
    {
      ...
      keywords: 'how bookyourservice works, book home service, online service booking, AC booking, fridge booking, plumber booking, electrician booking',
    ...
    },
    {
      ...
      keywords: 'about bookyourservice, home service platform India, verified service providers, home services marketplace',
    ...
    },
    {
      ...
      description: 'Find answers to common questions about BookYourService including booking, payments, cancellations, and our 11 service categories — Air Conditioner, Refrigerator, Washing Machine, Kitchen Appliances, TV Repair, Water Purifier, Geyser, Plumber, Electrician, Water Tank Cleaning, and Movers and Packers.',
      keywords: 'bookyourservice FAQ, frequently asked questions, home service questions, AC FAQ, plumber FAQ, electrician FAQ',
    ...
    },
    {
      ...
      description: 'Get in touch with BookYourService for support, queries, or feedback regarding our listed home services. We\'re here to help.',
      keywords: 'contact bookyourservice, customer support, home service help, AC support, plumber support, electrician support',
