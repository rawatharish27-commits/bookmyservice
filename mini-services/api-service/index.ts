...
const JOB_OFFER_TERMS = {
  ...
  sections: [
    ...
    { title: "7. No Civil Court Jurisdiction", content: "The Company shall not be responsible for any civil court cases filed by applicants. Any disputes arising out of or in connection with the application process shall be resolved through arbitration in accordance with the Arbitration and Conciliation Act, 1996. The arbitration shall be conducted in Palwal, Haryana, India, and the proceedings shall be in English. The decision of the arbitrator shall be final and binding on both parties." },
    { title: "8. Jurisdiction", content: "All disputes and legal proceedings shall be subject to the exclusive jurisdiction of the courts of Palwal, Haryana, India. This is in accordance with Section 20 of the Code of Civil Procedure, 1908." },
